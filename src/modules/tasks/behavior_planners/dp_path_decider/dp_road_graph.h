...
class DPRoadGraph : public Task {
 ...
 public:
  ...
  bool AddLaneBorrowVirtualObstacle(double obs_inner_l, double obs_start_s, double speed);
  bool NudgeOutPose(double path_ego_x, double path_ego_y, double path_ego_theta,
