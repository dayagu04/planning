...
class TrajectoryCost {
 public:
  TrajectoryCost(const SLPoint &init_sl_point,
                 double sample_left_boundary,
  ...
  ComparableCost CalculatePathCost(const QuinticPolynomialCurve1d &curve,
                                   const double start_s, const double end_s,
                                   int current_level, int total_level) const;
...
ComparableCost CalDynamicObsCartCost(const QuinticPolynomialCurve1d &curve,
  ...
  ComparableCost CalculateStitchCost(const QuinticPolynomialCurve1d &curve,
                                    const double start_s, const double end_s)const;
  void BuildCurveBorder(const QuinticPolynomialCurve1d &curve,const double start_s,
                                    const double end_s);
  ...
  void SetCostParams(double coeff_l_cost, double coeff_dl_cost, double coeff_ddl_cost,
                    double path_resolution, double coeff_end_l_cost, double coeff_collision_cost,
