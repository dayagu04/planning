#pragma once
#include "behavior_planners/lat_lon_joint_planner_decider/src/joint_motion_planning_model.h"
#include "ilqr_cost.h"
...
enum iLqrCostconfigId {
  ...
  W_SOFT_HALFPLANE,
  SOFT_HALFPLANE_S0,                     // 软约束基础距离
  SOFT_HALFPLANE_TAU,                    // 软约束时间系数
  SOFT_HALFPLANE_COST_ALLOCATION_RATIO,  // 软约束代价分配系数
  OBS_CONFIG_START,
};
