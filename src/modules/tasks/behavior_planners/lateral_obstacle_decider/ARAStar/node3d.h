...
class Node3d {
 public:
  ...
  void SetDeltaS(double s) { delta_s_ = s; }
  void SetReachDest(bool reach_dest) { reach_dest_ = reach_dest; }
  bool ReachDest() const { return reach_dest_; }
  void SetMinDist(double min_dist) { min_dist_ = min_dist; }
  double GetMinDist() const { return min_dist_; }
