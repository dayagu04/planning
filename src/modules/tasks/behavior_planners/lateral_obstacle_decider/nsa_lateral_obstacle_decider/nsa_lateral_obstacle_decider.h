...
class NSALateralObstacleDecider : public BaseLateralObstacleDecider {
 public:
  NSALateralObstacleDecider(const EgoPlanningConfigBuilder *config_builder,
                            framework::Session *session);
  virtual ~NSALateralObstacleDecider() = default;
