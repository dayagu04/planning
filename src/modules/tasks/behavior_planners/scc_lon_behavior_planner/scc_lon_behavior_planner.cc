...
bool SccLonBehaviorPlanner::JudgeCurvBySDMap() {
  ...
  std::cout << "ego_pose_x_:" << pose.position.x << "ego_pose_y_:" << pose.position.y
            << std::endl;
  ...
  curv_list = sd_map.GetCurvatureList(current_segment->id(), nearest_s, config_.search_sdmap_curv_dis);
