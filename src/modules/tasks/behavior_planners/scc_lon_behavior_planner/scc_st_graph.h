...
// /**
//  *  @file
//  *  @brief Construct obstacle S-T graph for generating S-bounds and
//  performing *velocity planning
//  **/
// #include <cstddef>
// #include <cstdint>
// #include <memory>
...
// #include
// "tasks/behavior_planners/real_time_lane_change_decider/real_time_lane_change_decider.h"
...
//                             const double acc_ego, std::vector<double>
//                             &s_refs);
...
//                          double ramp_v_limit, double acc_to_ramp, double
//                          v_ego);
...
//   bool CalcAccLimits(const planning::common::TrackedObjectInfo
//   &lead_obstacle,
...
//   double CalcSafeDistance(const double obstacle_velocity, const double
//   v_ego);
...
//       const planning::common::TrackedObjectInfo &lead_one,
//       const double v_cruise, const double v_ego, const std::string
//       &lc_request, const std::string &lc_status,
//       std::vector<planning::common::RealTimeLonObstacleSTInfo>
//           &lane_change_st_info);
...
//       std::shared_ptr<planning::planning_data::DynamicWorld> dynamic_world,
//       std::vector<planning::common::RealTimeLonObstacleSTInfo>
//       &merge_st_info, const double v_ego);

//   void MergeSplitStaitcInfoProcess(std::shared_ptr<VirtualLane>
//   current_lane);
...
//   std::shared_ptr<RealTimeLaneChangeDecider> lane_changing_decider_ =
//   nullptr; std::vector<double> st_refs_; std::vector<double> vt_refs_; double
//   v_target_; double last_v_target_; std::pair<double, double> acc_target_;
...
//   // headway params
//   const std::vector<double> AGGRESSIVE_HEADWAY_TABLE{1.2, 1.4, 1.6,
//   1.8, 2.0}; const std::vector<double> NORMAL_HEADWAY_TABLE{1.2, 1.5,
//   2.0, 2.5, 3.0}; const std::vector<double>
//   CONSERVATIVE_HEADWAY_TABLE{1.2, 1.8, 2.5, 3.0, 4.0}; const
//   std::vector<double> _HEADWAY_BP{0.0, 0.15, 0.35, 0.5, 1.0};
//   // linear slope
...
//   // NOTE: adjacent or rear agent merge info which is left or left rear or
//   right
//   // or right rear
