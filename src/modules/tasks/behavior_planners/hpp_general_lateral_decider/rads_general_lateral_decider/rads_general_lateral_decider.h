...
class RADSGeneralLateralDecider : public BaseGeneralLateralDecider {
 public:
  explicit RADSGeneralLateralDecider(
      const EgoPlanningConfigBuilder *config_builder,
      framework::Session *session);

  virtual ~RADSGeneralLateralDecider() = default;
 ...
 private:
  RADSGeneralLateralDeciderConfig config_;
