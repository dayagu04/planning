...
//   double GetLimitVelocityByFixedTime(const double fixed_time,
...
//                                      const PointState &init_state,
//                                      const double p_f);
//   PositionParam PositionTargetSolverByFixedTime(const StateLimitParam &state_limit,
//                                      const PointState &init_state,
//                                      const double p_f,const bool is_upper_limit);
