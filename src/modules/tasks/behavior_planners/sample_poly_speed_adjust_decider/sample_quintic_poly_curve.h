...
#include "trajectory1d/quintic_poly_trajectory1d.h"
namespace planning {
class SampleQuinticPolynomialCurve : public SamplePolyCurve {
 public:
  SampleQuinticPolynomialCurve() = default;
  SampleQuinticPolynomialCurve(
  ...
  void CostInit();
  // interface:
  const QuinticPolynomial& poly() const { return poly_; };
