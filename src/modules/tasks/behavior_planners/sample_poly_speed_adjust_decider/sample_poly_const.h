...
constexpr double kMaxDistanceToStopPoint = 1000.0;
constexpr double kDistanceToMapRequestPoint = 300.0;
...
constexpr double kStopLineBasicPenaltyDis_merge = 250.0;
constexpr double kStopLineNormalPenaltyDis_merge = 125.0;
...
constexpr double kMinSafeDistanceFront = 5.0;
...
constexpr double kJudePurseFlowVelValue = 5.0 / 3.6;
constexpr int kNormalToHoverThreshold = 10;
constexpr int kHoverToNormalThreshold = 10;
constexpr int kJudgeCongestedVehNumThreshold = 4;
constexpr double kVehDensityDistanceThreshold = 70.0;
constexpr double kJudgeCongestedSceneDensity = 18.0;
;
...
constexpr double kAccPenaltyScaleFactor = 1.0;
...
constexpr double kCongestedSceneSpeedLimit = 40.0 / 3.6;
constexpr double kLargeAgentLengthM = 8.0;
constexpr double kSampleSpeedCapMps = 130.0 / 3.6;
constexpr double kMaxSpeedDiffThreshold = 15.0 / 3.6;
}  // namespace planning