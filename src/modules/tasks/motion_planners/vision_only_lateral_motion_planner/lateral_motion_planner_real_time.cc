...
bool VisionLateralMotionPlanner::update_planner_output() {
  ...
  lateral_output.disable_l = 0;
  lateral_output.disable_r = 0;
  lateral_output.enable_l = 0;  // disabled
  //       ,enable的区别是啥？代表啥意思
  lateral_output.enable_r = 0;
  lateral_output.enable_id = 0;  //
  //   enable车的id？ 车道线的id?
