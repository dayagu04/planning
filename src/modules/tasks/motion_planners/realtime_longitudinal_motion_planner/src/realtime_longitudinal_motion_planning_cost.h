#ifndef __REALTIME_LONGITUDINAL_MOTION_PLANNING_COST_H__
#define __REALTIME_LONGITUDINAL_MOTION_PLANNING_COST_H__
...
// sv bound cost
class LonSVBoundCost : public ilqr_solver::BaseCostTerm {
 public:
  LonSVBoundCost() = default;
  double GetCost(const State &x, const Control & /*u*/) override;
  void GetGradientHessian(const State &x, const Control & /*u*/, LxMT &lx,
                          LuMT & /*lu*/, LxxMT &lxx, LxuMT & /*lxu*/,
                          LuuMT & /*luu*/) override;
