...
enum LaneBorrowFailedReason {
  ...
  SOLID_LINE_BORROW_DISABLED,   //实线不借道
  NO_PASSABLE_OBSTACLE,         //没有可通过的障碍物？
  SELF_LANE_ENOUGH,             //自车车道足够车道内避让
  LANE_TYPE_CHECK_FAILED,       //车道类型不对，机动车非机动车?
  OBSERVE_TIME_CHECK_FAILED,    //观测时间？
