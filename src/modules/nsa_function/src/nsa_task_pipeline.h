...
#include "tasks/behavior_planners/hmi_decider/mirror_decider/mirror_decider.h"
#include "tasks/motion_planners/lateral_motion_planner/nsa_lateral_motion_planner.h"
...
class NsaTaskPipeline : public BaseTaskPipeline {
 ...
 private:
  ...
  std::unique_ptr<NSALateralMotionPlanner> lateral_motion_planner_;
  ...
  std::unique_ptr<MirrorDecider> mirror_decider_;
};
