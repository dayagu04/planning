...
class MapRequest : public LaneChangeRequest {
 public:
  MapRequest(framework::Session* session, const EgoPlanningConfigBuilder* config_builder,
 ...
 private:
  ...
  void check_lc_forbid_reason(std::vector<std::string>& forbid_generating_left_reason,
                              std::vector<std::string>& forbid_generating_right_reason, int left_int_freeze_cnt,
