...
void PerpendicularParkHeadingInPlanner::Reset() {
  frame_.Reset();
  slot_t_lane_.Reset();
...
const double PerpendicularParkHeadingInPlanner::CalRemainDistFromPath() {
...
void PerpendicularParkHeadingInPlanner::PlanCore() {
  // prepare simulation
  InitSimulation();
...
void PerpendicularParkHeadingInPlanner::GenTlane() {
...
const uint8_t PerpendicularParkHeadingInPlanner::PathPlanOnce() {
...
const bool PerpendicularParkHeadingInPlanner::CheckFinished() {
  const auto& ego_slot_info = frame_.ego_slot_info;
...
const bool PerpendicularParkHeadingInPlanner::CheckSegCompleted() {
...
const bool PerpendicularParkHeadingInPlanner::CheckUssStucked() {
...
const bool PerpendicularParkHeadingInPlanner::CheckColDetStucked() {
...
const bool PerpendicularParkHeadingInPlanner::CheckDynamicUpdate() {
...
const bool PerpendicularParkHeadingInPlanner::CheckReplan() {
...
const bool PerpendicularParkHeadingInPlanner::PostProcessPath() {
...
const bool
PerpendicularParkHeadingInPlanner::PostProcessPathAccordingLimiter() {
...
void PerpendicularParkHeadingInPlanner::GenPlanningOutput() {
...
void PerpendicularParkHeadingInPlanner::Log() const {
  const EgoSlotInfo& ego_slot_info = frame_.ego_slot_info;
...
void PerpendicularParkHeadingInPlanner::GenPlanningPath() {
...
void PerpendicularParkHeadingInPlanner::RealTimeDynamicColDet(
