...
#include "perpendicular_path_out_planner.h"

namespace planning {
namespace apa_planner {

class PerpendicularParkOutPlanner : public PerpendicularParkPlanner {
 public:
  PerpendicularParkOutPlanner() = default;
  PerpendicularParkOutPlanner(const std::shared_ptr<ApaWorld>& apa_world_ptr) {
