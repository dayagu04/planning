...
void PerpendicularParkOutPlanner::Reset() {
  frame_.Reset();
  slot_t_lane_.Reset();
...
void PerpendicularParkOutPlanner::PlanCore() {
  // prepare simulation
  InitSimulation();
...
const bool PerpendicularParkOutPlanner::UpdateEgoSlotInfo() {
...
void PerpendicularParkOutPlanner::GenTlane() {
...
void PerpendicularParkOutPlanner::GenObstacles() {
...
const uint8_t PerpendicularParkOutPlanner::PathPlanOnce() {
...
const bool PerpendicularParkOutPlanner::CheckSegCompleted() {
...
const bool PerpendicularParkOutPlanner::CheckUssStucked() {
...
const bool PerpendicularParkOutPlanner::CheckColDetStucked() {
...
const bool PerpendicularParkOutPlanner::CheckReplan() {
...
const bool PerpendicularParkOutPlanner::CheckFinished() {
  const auto& ego_slot_info = frame_.ego_slot_info;
...
const bool PerpendicularParkOutPlanner::PostProcessPathAccordingObs(
...
void PerpendicularParkOutPlanner::Log() const {
  const EgoSlotInfo& ego_slot_info = frame_.ego_slot_info;
