...
const bool PerpendicularTailInScenario::GenTlane() {
  ...
  ILOG_INFO << "cur pose = " << ego_info_under_slot.cur_pose.GetX() << "  "
            << ego_info_under_slot.cur_pose.GetY() << "  "
            << ego_info_under_slot.cur_pose.heading * kRad2Deg
            << "  origin_tar_pose = "
            << ego_info_under_slot.origin_target_pose.GetX() << "  "
            << ego_info_under_slot.origin_target_pose.GetY() << "  "
            << ego_info_under_slot.origin_target_pose.heading * kRad2Deg
            << "  tar_pose = " << ego_info_under_slot.target_pose.GetX() << "  "
            << ego_info_under_slot.target_pose.GetY() << "  "
            << ego_info_under_slot.target_pose.heading * kRad2Deg
            << "  terminal_err = " << ego_info_under_slot.terminal_err.GetX()
