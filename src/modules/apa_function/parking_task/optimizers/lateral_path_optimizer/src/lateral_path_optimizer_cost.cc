...
double KBoundCostTerm::GetCost(const ilqr_solver::State &x,
  ...
  if (Square(x[K]) - Square(cost_config_ptr_->at(K_MAX)) +
          alilqr_config_ptr_->at(L_K_HARDBOUND) /
              alilqr_config_ptr_->at(W_K_HARDBOUND) >
      0.0) {
    cost += 0.5 * alilqr_config_ptr_->at(W_K_HARDBOUND) *
...
void KBoundCostTerm::GetGradientHessian(
  ...
  if (Square(x[K]) - Square(cost_config_ptr_->at(K_MAX)) +
          alilqr_config_ptr_->at(L_K_HARDBOUND) /
              alilqr_config_ptr_->at(W_K_HARDBOUND) >
      0.0) {
    lx(K) += (alilqr_config_ptr_->at(W_K_HARDBOUND) *
                  (Square(x[K]) - Square(cost_config_ptr_->at(K_MAX))) +
              alilqr_config_ptr_->at(L_K_HARDBOUND)) *
             (2.0 * x[K]);

    lxx(K, K) +=
        4.0 * Square(x[K]) * alilqr_config_ptr_->at(W_K_HARDBOUND) +
        2.0 * (alilqr_config_ptr_->at(W_K_HARDBOUND) *
                   (Square(x[K]) - Square(cost_config_ptr_->at(K_MAX))) +
               alilqr_config_ptr_->at(L_K_HARDBOUND));
  }
}
...
double UBoundCostTerm::GetCost(const ilqr_solver::State & /*x*/,
  ...
  if (Square(u[U]) - Square(cost_config_ptr_->at(U_MAX)) +
          alilqr_config_ptr_->at(L_U_HARDBOUND) /
              alilqr_config_ptr_->at(W_U_HARDBOUND) >
      0.0) {
    cost += 0.5 * alilqr_config_ptr_->at(W_U_HARDBOUND) *
...
void UBoundCostTerm::GetGradientHessian(const ilqr_solver::State & /*x*/,
  ...
  if (Square(u[U]) - Square(cost_config_ptr_->at(U_MAX)) +
          alilqr_config_ptr_->at(L_U_HARDBOUND) /
              alilqr_config_ptr_->at(W_U_HARDBOUND) >
      0.0) {
    lu(U) += (alilqr_config_ptr_->at(W_U_HARDBOUND) *
                  (Square(u[U]) - Square(cost_config_ptr_->at(U_MAX))) +
              alilqr_config_ptr_->at(L_U_HARDBOUND)) *
             (2.0 * u[U]);

    luu(U, U) +=
        4.0 * Square(u[U]) * alilqr_config_ptr_->at(W_U_HARDBOUND) +
        2.0 * (alilqr_config_ptr_->at(W_U_HARDBOUND) *
                   (Square(u[U]) - Square(cost_config_ptr_->at(U_MAX))) +
               alilqr_config_ptr_->at(L_U_HARDBOUND));
  }
}
