...
const bool GeometryPathGenerator::SamplePathSeg(
...
void GeometryPathGenerator::PrintSegmentInfo(
...
void GeometryPathGenerator::SampleLineSegment(
...
void GeometryPathGenerator::SampleArcSegment(const pnc::geometry_lib::Arc& cur_arc_seg,
                                      const double ds) {
...
void GeometryPathGenerator::SampleArcSegment(
    std::vector<pnc::geometry_lib::PathPoint>& path_point_vec,
...
const std::vector<double> GeometryPathGenerator::GetPathEle(size_t index) const {
