...
struct ParkStopConfig {
  ...
  // same direction obstacle;
  // reverse direction obstacle;
  // cross  direction obstacle;
  DecisionBufferBySpeed static_obs_buffer;
  DecisionBufferBySpeed slow_speed_buffer;
  DecisionBufferBySpeed middle_speed_buffer;
  DecisionBufferBySpeed high_speed_buffer;
  // m/s
  double slow_speed_thresh;
  double middle_speed_thresh;
