...
static const double min_radius = 5.7;
static const double min_radius_final = 5.4;
static const double kLineStep = 0.1;
static const double kMinProperLength = 0.5;
static const double plan_time = 0.1;
static const double terminal_target_x = 0.85;
...
static const double kSublaneWidth = 6.0;
