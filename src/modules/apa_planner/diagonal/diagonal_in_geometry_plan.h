...
class DiagonalInGeometryPlan {
 public:
  ...
  bool ABSegment(const PlanningPoint &point_a, bool is_start,
                 bool is_rough_calc, DiagonalSegmentsInfo *segments_info);
  ...
  bool CDSegment(const PlanningPoint &point_c, bool is_start,
                 bool is_rough_calc, DiagonalSegmentsInfo *segments_info);
  bool CD1Segment(const PlanningPoint &point_c, bool is_start,
                  bool is_rough_calc, DiagonalSegmentsInfo *segments_info);
  bool CD2Segment(const PlanningPoint &point_c, bool is_start,
                  bool is_rough_calc, DiagonalSegmentsInfo *segments_info);
  bool DE1Segment(const PlanningPoint &point_d, bool is_start,
                  bool is_rough_calc, DiagonalSegmentsInfo *segments_info);
  bool EFSegment(const PlanningPoint &point_e, bool is_start,
                 bool is_rough_calc, DiagonalSegmentsInfo *segments_info);
  bool CD3Segment(const PlanningPoint &point_c, bool is_start,
                  bool is_rough_calc, DiagonalSegmentsInfo *segments_info);
  bool DESegment(const PlanningPoint &point_d, bool is_start,
                 bool is_rough_calc, DiagonalSegmentsInfo *segments_info);
  bool DE2Segment(const PlanningPoint &point_d, bool is_start,
                  bool is_rough_calc, DiagonalSegmentsInfo *segments_info);
  bool DE3Segment(const PlanningPoint &point_d, bool is_start,
                  bool is_rough_calc, DiagonalSegmentsInfo *segments_info);
 ...
 private:
  std::vector<double> GetXslotCenterLineVec(
      const double max_x_slot_central_line_bias,
