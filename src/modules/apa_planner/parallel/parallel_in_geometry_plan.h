...
class ParallelInGeometryPlan {
 public:
  ...
  bool ABSegment(const PlanningPoint &point_a, bool is_start, bool is_rough_calc, ParallelSegmentsInfo *segments_info);
  ...
  bool BCSegment(const PlanningPoint &point_b, double len_ab, bool is_start, bool is_rough_calc,
                 ParallelSegmentsInfo *segments_info);
  bool CDSegment(const PlanningPoint &point_c, bool is_start, bool is_rough_calc, ParallelSegmentsInfo *segments_info);
  bool DESegment(const PlanningPoint &point_d, bool is_start, bool is_rough_calc, ParallelSegmentsInfo *segments_info);
  bool EFSegment(const PlanningPoint &point_e, bool is_start, bool is_rough_calc, ParallelSegmentsInfo *segments_info);
  bool EF1Segment(const PlanningPoint &point_e, bool is_start, bool is_rough_calc, ParallelSegmentsInfo *segments_info);
  bool EF2Segment(const PlanningPoint &point_e, bool is_start, bool is_rough_calc, ParallelSegmentsInfo *segments_info);
  bool FGSegment(const PlanningPoint &point_f, bool is_start, bool is_rough_calc, ParallelSegmentsInfo *segments_info);
  bool EF3Segment(const PlanningPoint &point_e, bool is_start, bool is_rough_calc, ParallelSegmentsInfo *segments_info);
  bool FHSegment(const PlanningPoint &point_f, bool is_start, bool is_rough_calc, ParallelSegmentsInfo *segments_info);
  bool FH1Segment(const PlanningPoint &point_f, bool is_start, bool is_rough_calc, ParallelSegmentsInfo *segments_info);
  bool FH2Segment(const PlanningPoint &point_f, bool is_start, bool is_rough_calc, ParallelSegmentsInfo *segments_info);
  bool HISegment(const PlanningPoint &point_h, bool is_start, bool is_rough_calc, ParallelSegmentsInfo *segments_info);
  bool FH3Segment(const PlanningPoint &point_f, bool is_start, bool is_rough_calc, ParallelSegmentsInfo *segments_info);
  ...
  const std::vector<planning_math::LineSegment2d> &GetObjectMap() const { return objects_map_line_segments_; }
