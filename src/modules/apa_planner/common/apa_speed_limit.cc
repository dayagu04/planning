...
#include "apa_planner/common/apa_speed_limit.h"
...
void ApaSpeedLimit::AppendSpeedLimit(const double s, const double v) {
...
const std::vector<std::pair<double, double>>& ApaSpeedLimit::speed_limit_points()
    const {
...
void ApaSpeedLimit::Clear() { speed_limit_points_.clear(); }
