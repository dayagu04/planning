...
class PiecewiseJerkTrajectory1d : public Trajectory1d {
 public:
  // TODO(all): remove the parameter init_param after the
  // reference_curve_generator related code is removed.
  ...
  void AppendSegment(const double p, const double v, const double a,
                     const double param);
