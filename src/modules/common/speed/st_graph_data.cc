...
void StGraphData::load_output_data(const BarrierPairList& lane_keep_sv,
...
const StGraphData::BarrierPairList &
StGraphData::get_lane_keep_sv() const {
  return lane_keep_sv_;
}

const StGraphData::BarrierArray &
StGraphData::get_normal_sv() const {
  return normal_sv_;
}

const StGraphData::BarrierList &
StGraphData::get_yield_sv() const {
  return yield_sv_;
}
...
const StGraphData::BarrierList &
StGraphData::get_potential_sv() const {
  return lane_keep_potential_sv_;
}

const StGraphData::ObstacleTagList &
StGraphData::get_obstacle_tag() const {
