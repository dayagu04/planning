...
/*!
 * @brief Given two axis aligned rectangles represented by 2 points (bottom-left point and upper-right point), compute the distance represented by a tuple of x-axis distance and y-axis distance
 * @param rectangle 1
 * @param rectangle 2
