...
const bool UssObstacle::CheckTwoCircleIntersection(const Circle &c1,
...
UssObstacle::GetTwoCircleIntersection(const Circle &c1,
                                      const Circle &c2) const {
  const double d = (c1.center - c2.center).norm();
...
const bool UssObstacle::CheckPointLiesOnArc(const Arc &arc,
...
const bool UssObstacle::GetTwoArcIntersection(Eigen::Vector2d &intersection,
                                              const Arc &arc1,
                                              const Arc &arc2) const {
...
const bool UssObstacle::GetArcLineIntersection(Eigen::Vector2d &intersection,
                                               const Arc &arc1,
...
void UssObstacle::CalRemainDist() {
...
const pnc::geometry_lib::LineSegment UssObstacle::GetMinDistUssLine() const {
