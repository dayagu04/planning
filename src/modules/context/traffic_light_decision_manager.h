...
public:
  ...
  const iflyauto::CameraPerceptionTrafficStatus& GetTrafficStatus() {return traffic_status_;};

  const std::vector<iflyauto::CameraPerceptionTrafficLight>& GetTrafficLightsInfo() {return traffic_lights_info_;};
