...
struct JointMotionPlannerConfig : public EgoPlanningConfig {
  void init(const Json &json) override {
    ...
    ReadItem<double>(json, q_obs_ref_x, "lat_lon_joint_planner", "q_obs_ref_x");
    ReadItem<double>(json, q_obs_ref_y, "lat_lon_joint_planner", "q_obs_ref_y");
    ReadItem<double>(json, q_obs_ref_theta, "lat_lon_joint_planner",
                     "q_obs_ref_theta");
    ReadItem<double>(json, q_obs_ref_delta, "lat_lon_joint_planner",
                     "q_obs_ref_delta");
    ReadItem<double>(json, q_obs_ref_vel, "lat_lon_joint_planner",
                     "q_obs_ref_vel");
    ReadItem<double>(json, q_obs_ref_acc, "lat_lon_joint_planner",
                     "q_obs_ref_acc");
    ...
    ReadItem<double>(json, q_ego_delta_weight, "lat_lon_joint_planner",
                     "q_ego_delta_weight");
    ReadItem<double>(json, q_obs_jerk_weight, "lat_lon_joint_planner",
                     "q_obs_jerk_weight");
    ReadItem<double>(json, q_obs_omega_weight, "lat_lon_joint_planner",
                     "q_obs_omega_weight");
    ...
    ReadItem<double>(json, hard_halfplane_dist, "lat_lon_joint_planner",
                     "hard_halfplane_dist");
    ReadItem<double>(json, halfplane_cost_allocation_ratio, "lat_lon_joint_planner",
  ...
  double q_obs_ref_vel = 0.2;
  double q_obs_ref_acc = 0.5;
