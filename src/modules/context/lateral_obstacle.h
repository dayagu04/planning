...
//   bool update(const EgoStateManager &ego_state,
...
// private:
//   bool update_sensors(const EgoStateManager &ego_state,
//                       const std::vector<PredictionObject> &predictions,
//                       bool isRedLightStop, bool hdmap_valid);
...
//   void update_ego_state(const EgoState& ego_state) {
//     ego_state_ = ego_state;
//   }

//   double get_drel_close(int side);
//   double get_vrel_close(int side, int status);
//   const std::vector<TrackedObject> &front_tracks_l() const { return front_tracks_llane_; }
//   const std::vector<TrackedObject> &front_tracks_r() const { return front_tracks_rlane_; }
