...
// LaneReferencePath::LaneReferencePath(int target_lane_id) : ReferencePath() {
//   target_lane_id_ = target_lane_id;
//   // update();
//   LOG_DEBUG("lane_reference_path: target_lane_id: %d", target_lane_id);
// }
...
//   bool ok = get_points_by_lane_id(target_lane_id_, points);
...
//   obstacle_manager->get_reference_path_virtual_obstacles(target_lane_id_, *this,
//                                                          frenet_obstacles_);
...
//     int target_lane_id, ReferencePathPoints &ref_path_points) {
