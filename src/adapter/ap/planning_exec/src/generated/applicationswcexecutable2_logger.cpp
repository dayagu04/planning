...
LogConfig Applicationswcexecutable2Logger::logConfig_ = {"Applicationswcexecutable2",
    "ApplicationSwcExecutable2 context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> Applicationswcexecutable2Logger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> Applicationswcexecutable2Logger::loggerCtxMap_;
...
void Applicationswcexecutable2Logger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* Applicationswcexecutable2Logger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String Applicationswcexecutable2Logger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> Applicationswcexecutable2Logger::GetSpecifyLogMode(
...
ara::log::LogLevel Applicationswcexecutable2Logger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode Applicationswcexecutable2Logger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig Applicationswcexecutable2Logger::ParseLogConfig()
{
    ...
    LogConfig logConfig = { "SCFI", "ApplicationSwcExecutable2 context",
...
bool Applicationswcexecutable2Logger::DoesFileExist(const ara::core::String& filePath)
{
