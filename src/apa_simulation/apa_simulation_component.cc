...
bool ApaSimulationComponent::Init() {
  ...
  common::util::GetProtoFromFile(apa_sim_parking_fusion_info_path,
                                 &parking_fusion_info_msg_);
  ...
  func_state_machine_writer_ = simulation_node_->CreateWriter<FuncStateMachine>(
...
bool ApaSimulationComponent::Proc() {
  // APA_SIM_LOG << "=======Apa simulation component running=======" <<
  // std::endl;
