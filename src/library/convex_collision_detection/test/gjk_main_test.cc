...
TEST(test_collision_detection_gik2d, test_Support2D) {
   ...
   * search direction(v) */
  size_t ret;
  cdl::ShapeProxy2D body;
  cdl::Vector2r v;

  /* body.size = 1 */
  v = {0.0, 0.0};
  body.size = 1;
  ret = cdl::Support2D(body, v);
  EXPECT_EQ(ret, 0);
...
TEST(test_collision_detection_gik2d, test_localMinimum1) {
  ...
  Position2D P_pos[5] = {{3, 0}, {4, -2}, {5, -2}, {5, 2}, {4, 2}};
  ...
  Position2D P_pos_case2[5] = {{3, 0}, {4, -1}, {5, -1}, {5, 2}, {4, 2}};
...
TEST(test_collision_detection_gik2d, test_localMinimum2) {
  ...
  Position2D P_pos_case1[6] = {{3, 0}, {4, -2}, {5, -2},
                               {6, 0}, {5, 2},  {4, 2}};

  Position2D Q_pos_case1[6] = {{1, 0}, {2, -2}, {3, -2},
                               {4, 0}, {3, 2},  {2, 2}};
...
TEST(test_collision_detection_gik2d, test_localMinimum) {
  ...
  Position2D Q_pos[5] = {{2, 2}, {3, -2}, {4, 0}, {3, 2}, {2, 2}};
...
TEST(test_collision_detection_gik2d, test_S2D2dVertexRegion) {
  ...
  region = cdl::GJK2D::VertexRegion::B_VERTEX;  // Obtuse angle
  ...
  region = cdl::GJK2D::VertexRegion::B_VERTEX;  // Acute angle
...
TEST(test_collision_detection_gik2d, test_Collision) {
  ...
  /* no collision */
  Position2D P_pos[4] = {{2, 2}, {1, 3}, {0, 2}, {1, 1}};

  Position2D Q_pos[3] = {{4, 0.5}, {2, 1.5}, {2, 0.5}};
  ...
  Position2D P_pos_case2[4] = {{2, 2}, {1, 3}, {0, 2}, {1, 1}};
  ...
  /* Face collision */
  Position2D P_pos_case3[4] = {{2, 2}, {1, 3}, {0, 2}, {1, 1}};
  ...
  Position2D P_pos_case4[4] = {{2, 2}, {1, 3}, {0, 2}, {1, 1}};
...
TEST(test_collision_detection_gik2d, test_collision_test02) {
  ...
  /* no collision */
  Position2D P_pos[4] = {{-77171.33027, 4389770.40190},
                         {-77172.81957, 4389768.44394},
                         {-77169.13846, 4389765.64394},
                         {-77167.64916, 4389767.60189}};

  Position2D Q_pos[7] = {
      {-77172.88329, 4389771.01634}, {-77172.95072, 4389769.96127},
      {-77172.80062, 4389769.77367},

      {-77172.29165, 4389769.39477}, {-77171.50128, 4389769.56122},
      {-77171.05531, 4389769.85848}, {-77171.09032, 4389769.93234}};
  ...
  Position2D P_pos_case02[4] = {{1, 0}, {0, 2}, {-1, 0}, {0, -2}};

  Position2D Q_pos_case02[4] = {{2, 2}, {1, 4}, {0, 2}, {1, 0}};
  ...
  Position2D P_pos_case03[3] = {{0, 0}, {0, 4}, {-6, 0}};

  Position2D Q_pos_case03[4] = {{-5, -2}, {-5, 2}, {-9, 2}, {-9, -2}};
...
TEST(test_collision_detection_gik2d, test_Distance) {
  ...
  EXPECT_NEAR(1.0 / ifly_sqrt(2) / 2.0, gjk2d_result.distance, error);
  ...
  Position2D P_pos_case2_02[4] = {{2, 2}, {1, 3}, {0, 2}, {1, 1}};

  Position2D Q_pos_case2_02[2] = {{0, 2}, {2, 2}};
