...
TEST(test_collision_detection_epa2d, test_originToEdgeDistance) {
  ...
  EXPECT_FLOAT_EQ(ret, 1.0 / ifly_sqrt(5) / 2.0);

  point1 = {-2.0, 0.0};
  point2 = {-1.0, 1.0};
  ret = epa2d.originToEdgeDistance(point1, point2);
  EXPECT_FLOAT_EQ(ret, -ifly_sqrt(2.0));
...
TEST(test_collision_detection_epa2d, test_pointToEdgeDistance) {
  ...
  EXPECT_FLOAT_EQ(ret, ifly_sqrt(2) / 2.0);

  point = {0, -1};
  ret = epa2d.pointToEdgeDistance(point, edge_p0, edge_p1);
  EXPECT_FLOAT_EQ(ret, ifly_sqrt(2));

  point = {0, -2};
  ret = epa2d.pointToEdgeDistance(point, edge_p0, edge_p1);
  EXPECT_FLOAT_EQ(ret, 3.0 / ifly_sqrt(2));
}
...
TEST(test_collision_detection_epa2d, test_zeroOrderSimplexExpanding) {
  ...
  Position2D P_pos_case1[6] = {{-1, 0}, {4, -2}, {5, -2},
                               {6, 0},  {5, 2},  {4, 2}};

  Position2D Q_pos_case1[1] = {{0, 0}};
...
TEST(test_collision_detection_epa2d, test_Penetration) {
  ...
  EXPECT_FLOAT_EQ(epa_result.distance, -2.0 / ifly_sqrt(5));
}
...
TEST(test_collision_detection_epa2d, test_Penetration2) {
  ...
  /* contain */
  Position2D P_pos_case2[4] = {{-1, -1}, {1, -1}, {1, 1}, {-1, 1}};

  Position2D Q_pos_case2[4] = {{-2, -2}, {2, -2}, {2, 2}, {-2, 2}};
  ...
  Position2D P_pos_case3[4] = {{-1, -1}, {1, -1}, {1, 1}, {-1, 1}};

  Position2D Q_pos_case3[4] = {{-2, -2}, {2, -2}, {2, 2}, {-1, -1}};
  ...
  EXPECT_FLOAT_EQ(epa_result.distance, -ifly_sqrt(2.0));
}