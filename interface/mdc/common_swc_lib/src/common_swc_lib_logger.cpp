...
LogConfig CommonSwcLibLogger::logConfig_ = {"CommonSwcLib",
    "common_swc_lib context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> CommonSwcLibLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> CommonSwcLibLogger::loggerCtxMap_;
std::mutex CommonSwcLibLogger::ctxMapMutex_;
std::mutex CommonSwcLibLogger::loggerCtxMapMutex_;

void CommonSwcLibLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void CommonSwcLibLogger::InitAppLogging()
{
    SetLogConfig();
...
void CommonSwcLibLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* CommonSwcLibLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String CommonSwcLibLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> CommonSwcLibLogger::GetSpecifyLogMode(
...
ara::log::LogLevel CommonSwcLibLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode CommonSwcLibLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig CommonSwcLibLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "common_swc_lib context",
...
bool CommonSwcLibLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool CommonSwcLibLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
