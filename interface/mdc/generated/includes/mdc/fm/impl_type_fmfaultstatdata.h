...
struct FmFaultStatData {
    ...
    {
        return (lhs.faultCnt == rhs.faultCnt) && (lhs.faultClearCnt == rhs.faultClearCnt) && (lhs.minTimeInvl == rhs.minTimeInvl) && (lhs.maxTimeInvl == rhs.maxTimeInvl) && (lhs.avgTimeInvl == rhs.avgTimeInvl) && (lhs.alarmCnt == rhs.alarmCnt) && (lhs.alarmClearCnt == rhs.alarmClearCnt);
    }
};
} // namespace fm
} // namespace mdc
