...
#include "legacy/interface2.4.5/common_c.h"
using namespace iflyauto;

template <typename T2>
void convert(iflyauto::interface_2_4_5::Point2si &struct_v, T2 &&ros_v, ConvertTypeInfo type) {
  convert(struct_v.x, ros_v.x, type);
  convert(struct_v.y, ros_v.y, type);
}

template <typename T2>
void convert(iflyauto::interface_2_4_5::Point2f &struct_v, T2 &&ros_v, ConvertTypeInfo type) {
  convert(struct_v.x, ros_v.x, type);
  convert(struct_v.y, ros_v.y, type);
}

template <typename T2>
void convert(iflyauto::interface_2_4_5::Point2d &struct_v, T2 &&ros_v, ConvertTypeInfo type) {
  convert(struct_v.x, ros_v.x, type);
  convert(struct_v.y, ros_v.y, type);
}

template <typename T2>
void convert(iflyauto::interface_2_4_5::Point3si &struct_v, T2 &&ros_v, ConvertTypeInfo type) {
  convert(struct_v.x, ros_v.x, type);
  convert(struct_v.y, ros_v.y, type);
...
template <typename T2>
void convert(iflyauto::interface_2_4_5::Point3f &struct_v, T2 &&ros_v, ConvertTypeInfo type) {
  convert(struct_v.x, ros_v.x, type);
  convert(struct_v.y, ros_v.y, type);
  convert(struct_v.z, ros_v.z, type);
}
...
template <typename T2>
void convert(iflyauto::interface_2_4_5::Point3d &struct_v, T2 &&ros_v, ConvertTypeInfo type) {
  convert(struct_v.x, ros_v.x, type);
  convert(struct_v.y, ros_v.y, type);
  convert(struct_v.z, ros_v.z, type);
}
...
template <typename T2>
void convert(iflyauto::interface_2_4_5::Shape3f &struct_v, T2 &&ros_v, ConvertTypeInfo type) {
...
template <typename T2>
void convert(iflyauto::interface_2_4_5::Shape3d &struct_v, T2 &&ros_v, ConvertTypeInfo type) {
  convert(struct_v.length, ros_v.length, type);
  convert(struct_v.width, ros_v.width, type);
  convert(struct_v.height, ros_v.height, type);
}
...
template <typename T2>
void convert(iflyauto::interface_2_4_5::PointENU &struct_v, T2 &&ros_v, ConvertTypeInfo type) {
  convert(struct_v.x, ros_v.x, type);
  convert(struct_v.y, ros_v.y, type);
  convert(struct_v.z, ros_v.z, type);
}
...
template <typename T2>
void convert(iflyauto::interface_2_4_5::TileId &struct_v, T2 &&ros_v, ConvertTypeInfo type) {
  convert(struct_v.id, ros_v.id, type);
}

template <typename T2>
void convert(iflyauto::interface_2_4_5::UrId &struct_v, T2 &&ros_v, ConvertTypeInfo type) {
  convert(struct_v.id, ros_v.id, type);
}

template <typename T2>
void convert(iflyauto::interface_2_4_5::PointLLH &struct_v, T2 &&ros_v, ConvertTypeInfo type) {
...
template <typename T2>
void convert(iflyauto::interface_2_4_5::Quaternion &struct_v, T2 &&ros_v, ConvertTypeInfo type) {
...
template <typename T2>
void convert(iflyauto::interface_2_4_5::InputHistoryInfo &struct_v, T2 &&ros_v, ConvertTypeInfo type) {
  convert(struct_v.input_type, ros_v.input_type, type);
  convert(struct_v.seq, ros_v.seq, type);
}

template <typename T2>
void convert(iflyauto::interface_2_4_5::CommonCameraPerceptionInputTimestamp &struct_v, T2 &&ros_v, ConvertTypeInfo type) {
...
template <typename T2>
void convert(iflyauto::interface_2_4_5::Header &struct_v, T2 &&ros_v, ConvertTypeInfo type) {
...
template <typename T2>
void convert(iflyauto::interface_2_4_5::Obstacle &struct_v, T2 &&ros_v, ConvertTypeInfo type) {
  convert(struct_v.id, ros_v.id, type);
...
template <typename T2>
void convert(iflyauto::interface_2_4_5::LaneMergeSplitPointData &struct_v, T2 &&ros_v, ConvertTypeInfo type) {
...
template <typename T2>
void convert(iflyauto::interface_2_4_5::UtcTime &struct_v, T2 &&ros_v, ConvertTypeInfo type) {
...
template <typename T2>
void convert(iflyauto::interface_2_4_5::LaneMarkMsg &struct_v, T2 &&ros_v, ConvertTypeInfo type) {
...
template <typename T2>
void convert(iflyauto::interface_2_4_5::LaneTypeMsg &struct_v, T2 &&ros_v, ConvertTypeInfo type) {
  convert(struct_v.begin, ros_v.begin, type);
  convert(struct_v.end, ros_v.end, type);
  convert(struct_v.type, ros_v.type, type);
}
