...
#include "legacy/interface2.4.6/common_c.h"
using namespace iflyauto;

template <typename T2>
void convert(iflyauto::interface_2_4_6::Point2si &struct_v, T2 &&ros_v, ConvertTypeInfo type) {
  convert(struct_v.x, ros_v.x, type);
  convert(struct_v.y, ros_v.y, type);
}

template <typename T2>
void convert(iflyauto::interface_2_4_6::Point2f &struct_v, T2 &&ros_v, ConvertTypeInfo type) {
  convert(struct_v.x, ros_v.x, type);
  convert(struct_v.y, ros_v.y, type);
}

template <typename T2>
void convert(iflyauto::interface_2_4_6::Point2d &struct_v, T2 &&ros_v, ConvertTypeInfo type) {
  convert(struct_v.x, ros_v.x, type);
  convert(struct_v.y, ros_v.y, type);
}

template <typename T2>
void convert(iflyauto::interface_2_4_6::Point3si &struct_v, T2 &&ros_v, ConvertTypeInfo type) {
  convert(struct_v.x, ros_v.x, type);
  convert(struct_v.y, ros_v.y, type);
...
template <typename T2>
void convert(iflyauto::interface_2_4_6::Point3f &struct_v, T2 &&ros_v, ConvertTypeInfo type) {
  convert(struct_v.x, ros_v.x, type);
  convert(struct_v.y, ros_v.y, type);
  convert(struct_v.z, ros_v.z, type);
}
...
template <typename T2>
void convert(iflyauto::interface_2_4_6::Point3d &struct_v, T2 &&ros_v, ConvertTypeInfo type) {
  convert(struct_v.x, ros_v.x, type);
  convert(struct_v.y, ros_v.y, type);
  convert(struct_v.z, ros_v.z, type);
}
...
template <typename T2>
void convert(iflyauto::interface_2_4_6::Shape3f &struct_v, T2 &&ros_v, ConvertTypeInfo type) {
...
template <typename T2>
void convert(iflyauto::interface_2_4_6::Shape3d &struct_v, T2 &&ros_v, ConvertTypeInfo type) {
  convert(struct_v.length, ros_v.length, type);
  convert(struct_v.width, ros_v.width, type);
  convert(struct_v.height, ros_v.height, type);
}
...
template <typename T2>
void convert(iflyauto::interface_2_4_6::PointENU &struct_v, T2 &&ros_v, ConvertTypeInfo type) {
  convert(struct_v.x, ros_v.x, type);
  convert(struct_v.y, ros_v.y, type);
  convert(struct_v.z, ros_v.z, type);
}
...
template <typename T2>
void convert(iflyauto::interface_2_4_6::TileId &struct_v, T2 &&ros_v, ConvertTypeInfo type) {
  convert(struct_v.id, ros_v.id, type);
}

template <typename T2>
void convert(iflyauto::interface_2_4_6::UrId &struct_v, T2 &&ros_v, ConvertTypeInfo type) {
  convert(struct_v.id, ros_v.id, type);
}

template <typename T2>
void convert(iflyauto::interface_2_4_6::PointLLH &struct_v, T2 &&ros_v, ConvertTypeInfo type) {
...
template <typename T2>
void convert(iflyauto::interface_2_4_6::Quaternion &struct_v, T2 &&ros_v, ConvertTypeInfo type) {
...
template <typename T2>
void convert(iflyauto::interface_2_4_6::InputHistoryInfo &struct_v, T2 &&ros_v, ConvertTypeInfo type) {
  convert(struct_v.input_type, ros_v.input_type, type);
  convert(struct_v.seq, ros_v.seq, type);
}

template <typename T2>
void convert(iflyauto::interface_2_4_6::CommonCameraPerceptionInputTimestamp &struct_v, T2 &&ros_v, ConvertTypeInfo type) {
...
template <typename T2>
void convert(iflyauto::interface_2_4_6::Header &struct_v, T2 &&ros_v, ConvertTypeInfo type) {
  convert(struct_v.timestamp, ros_v.timestamp, type);
  convert(struct_v.start_timestamp, ros_v.start_timestamp, type);
...
template <typename T2>
void convert(iflyauto::interface_2_4_6::Obstacle &struct_v, T2 &&ros_v, ConvertTypeInfo type) {
  convert(struct_v.id, ros_v.id, type);
...
template <typename T2>
void convert(iflyauto::interface_2_4_6::LaneMergeSplitPointData &struct_v, T2 &&ros_v, ConvertTypeInfo type) {
...
template <typename T2>
void convert(iflyauto::interface_2_4_6::UtcTime &struct_v, T2 &&ros_v, ConvertTypeInfo type) {
...
template <typename T2>
void convert(iflyauto::interface_2_4_6::LaneMarkMsg &struct_v, T2 &&ros_v, ConvertTypeInfo type) {
...
template <typename T2>
void convert(iflyauto::interface_2_4_6::LaneTypeMsg &struct_v, T2 &&ros_v, ConvertTypeInfo type) {
  convert(struct_v.begin, ros_v.begin, type);
  convert(struct_v.end, ros_v.end, type);
  convert(struct_v.type, ros_v.type, type);
}
