...
def run():
  sub_folders = [
    "src", "include/msd", "sample", "adaptor/mfr", "adaptor/ros/scripts",
    "adaptor/ros/src", "tools", "test/src", "adaptor/motionwise/include",
    "adaptor/motionwise/pie_wrapper", "adaptor/motionwise/script",
    "adaptor/motionwise/src", "adaptor/ap"
  ]
  _run_cpp(sub_folders)
  sub_folders = ["adaptor/ros/scripts", ".ci"]
  _run_py(sub_folders)
