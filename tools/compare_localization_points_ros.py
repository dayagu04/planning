...
def dump_localization_points(bag_path, bag_loc_point, topic_name):
    try:
        ...
        bag_loc_point["x"] = []
        bag_loc_point["y"] = []
        for topic_name, msg, t in bag.read_messages(topic_name):
...
if __name__ == '__main__':
    ...
    bag1_path = "/data_cold/abu_zone/autoparse/chery_e0y_04228/trigger/20240611/20240611-21-26-38/data_collection_CHERY_E0Y_04228_EVENT_MANUAL_2024-06-11-21-26-38_no_camera.bag"
    bag2_path = "/data_cold/abu_zone/autoparse/chery_e0y_04228/trigger/20240611/20240611-21-26-38/data_collection_CHERY_E0Y_04228_EVENT_MANUAL_2024-06-11-21-26-38_no_camera.bag.1718175484.plan"
