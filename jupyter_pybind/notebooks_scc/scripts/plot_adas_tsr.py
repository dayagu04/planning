...
f_road_type = fig_speed_info.line('time', 'current_road_type_', source = tsr_json_list_dict, line_width = 2, line_color = 'green', line_dash = 'solid', legend_label = 'road_type')
