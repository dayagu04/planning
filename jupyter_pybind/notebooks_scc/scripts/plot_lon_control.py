...
bag_path = "/data_cold/abu_zone/autoparse/chery_e0y_04228/trigger/20240531/20240531-18-14-03/data_collection_CHERY_E0Y_04228_EVENT_MANUAL_2024-05-31-18-14-03_no_camera.bag"
frame_dt = 0.02 # sec
...
def slider_callback(bag_time):
  ...
  dx_ref_mpc_vec = local_view_data['data_msg']['ctrl_debug_json_msg']['dx_ref_mpc_vec']
  dy_ref_mpc_vec = local_view_data['data_msg']['ctrl_debug_json_msg']['dy_ref_mpc_vec']
  dx_mpc_vec = local_view_data['data_msg']['ctrl_debug_json_msg']['dx_mpc_vec']
  dy_mpc_vec = local_view_data['data_msg']['ctrl_debug_json_msg']['dy_mpc_vec']
  delta_mpc_vec = local_view_data['data_msg']['ctrl_debug_json_msg']['delta_mpc_vec']
  dphi_ref_mpc_vec = local_view_data['data_msg']['ctrl_debug_json_msg']['dphi_ref_mpc_vec']
  dphi_mpc_vec = local_view_data['data_msg']['ctrl_debug_json_msg']['dphi_mpc_vec']
