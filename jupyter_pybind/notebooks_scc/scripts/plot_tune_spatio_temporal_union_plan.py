...
class LocalViewSlider:
  def __init__(self):
    ...
    self.path_dl_cost_slider = ipywidgets.FloatSlider(layout=ipywidgets.Layout(width='50%'), description= "path_dl_cost",min=0.0, max=1e5, value=spatio_temporal_union_plan_input.lat_path_weight_params.path_dl_cost, step=10, style=widgets.SliderStyle(description_width='initial'))
    self.path_ddl_cost_slider = ipywidgets.FloatSlider(layout=ipywidgets.Layout(width='50%'), description="path_ddl_cost", min=0.0, max=1e6,
    ...
    self.low_speed_penalty_slider = ipywidgets.FloatSlider(layout=ipywidgets.Layout(width='50%'), description="low_speed_penalty", min=0.0, max=1.0e2,
                                                          value=spatio_temporal_union_plan_input.long_weight_params.low_speed_penalty, step=1.0, style=widgets.SliderStyle(description_width='initial'))
    self.reference_speed_penalty_slider = ipywidgets.FloatSlider(layout=ipywidgets.Layout(width='50%'), description= "reference_speed_penalty",min=0.0, max=1.0e2, value=spatio_temporal_union_plan_input.long_weight_params.reference_speed_penalty, step=1.0, style=widgets.SliderStyle(description_width='initial'))
    self.accel_penalty_slider = ipywidgets.FloatSlider(layout=ipywidgets.Layout(width='50%'), description= "accel_penalty",min=0.0, max=1e2, value=spatio_temporal_union_plan_input.long_weight_params.accel_penalty, step=1.0, style=widgets.SliderStyle(description_width='initial'))
    self.decel_penalty_slider = ipywidgets.FloatSlider(layout=ipywidgets.Layout(width='50%'), description= "decel_penalty",min=0.0, max=1e2, value=spatio_temporal_union_plan_input.long_weight_params.decel_penalty, step=1.0, style=widgets.SliderStyle(description_width='initial'))
    self.positive_jerk_coeff_slider = ipywidgets.FloatSlider(layout=ipywidgets.Layout(width='50%'), description= "positive_jerk_coeff",min=0.0, max=1.0e2, value=spatio_temporal_union_plan_input.long_weight_params.positive_jerk_coeff, step=1.0, style=widgets.SliderStyle(description_width='initial'))
    self.negative_jerk_coeff_slider = ipywidgets.FloatSlider(layout=ipywidgets.Layout(width='50%'), description= "negative_jerk_coeff",min=0.0, max=1.0e2, value=spatio_temporal_union_plan_input.long_weight_params.negative_jerk_coeff, step=1.0, style=widgets.SliderStyle(description_width='initial'))
