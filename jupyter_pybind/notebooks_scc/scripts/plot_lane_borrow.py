...
bag_path = '/root/clzhao/lane_borrow_data/adata_2024-11-21-17-14-32.bag_2024-11-21-21-26-20.1732603426.close-loop.scc.plan'
bag_path= '/root/clzhao/lane_borrow_data/adata_2024-11-21-17-14-32.bag_2024-11-21-21-26-20.1732609229.close-loop.scc.plan'
# -
...
def load_lane_borrow_tab_info(dataLoader, layer_manager):
  ...
  for i, plan_debug in enumerate(dataLoader.plan_debug_msg['data']):
    ...
    vars = ['lane_borrow_decider_status','ego_l','target_left_l','target_right_l','safe_left_borrow','safe_right_borrow',  'static_blocked_obj_vec','lane_borrow_failed_reason']
    names  = []
    datas = []
    for name in vars:
      try:
...
def plotOnce(bag_path, html_file):
  ...
  """
    ...
    pans = Tabs(tabs=[pan_lane_borrow_info])
