...
bag_path = "/data_cold/abu_zone/autoparse/chery_m32t_50813/trigger/20250904/20250904-15-29-47/data_collection_CHERY_M32T_50813_EVENT_FUNEXIT_2025-09-04-15-29-47_no_camera.bag.1760687707.open-loop.scc.plan"
...
def slider_callback(bag_time, prediction_obstacle_id, obstacle_polygon_id):
  ...
  if bag_loader.plan_debug_msg['enable'] == True:
    ...
    data_hmi_construction_agent_info_table = update_construction_agent_info(local_view_data)
...
pan4 = Panel(child=row(column(data_hmi_construction_agent_info_table)), title="construction_agent_clusters")
pan5 = Panel(child=row(column(fig7)), title="!Figure")
pans = Tabs(tabs=[ pan1, pan2, pan3, pan4 , pan5])
if global_fig_plot:
