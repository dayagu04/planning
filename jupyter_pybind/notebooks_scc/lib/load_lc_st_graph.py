...
def load_lc_path_figure():
  ...
  fig2 = bkp.figure(x_axis_label='t', y_axis_label='s', x_range = [-0.1, 7.0], width=800, height=800, match_aspect = True, aspect_scale=1)
  ...
  fig2.line('t', 'front_obj_need_dis_vec', source = data_st, legend_label="FOBJ need s", line_width=2, color = "red", line_dash='dashed')
  fig2.line('t', 'rear_obj_need_dis_vec', source = data_st, legend_label="ROBJ need s", line_width=2, color = "yellow", line_dash='dashed')
