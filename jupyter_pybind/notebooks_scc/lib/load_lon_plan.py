...
def load_lon_global_figure(bag_loader):
  ...
  fig_fsm_state.text(x=t_soc_state[10], y=8, text=['SCC_STANDBY:7'], text_align='left', text_baseline='middle', text_font_size='9pt', text_color='black')
  fig_fsm_state.text(x=t_soc_state[10], y=10, text=['SCC_ACTIVE:8'], text_align='left', text_baseline='middle', text_font_size='9pt', text_color='black')
  fig_fsm_state.text(x=t_soc_state[10], y=2, text=['SCC_OVERRIDE:9'], text_align='left', text_baseline='middle', text_font_size='9pt', text_color='black')
  fig_fsm_state.text(x=t_soc_state[10], y=6, text=['NOA_STANDBY:10'], text_align='left', text_baseline='middle', text_font_size='9pt', text_color='black')
  fig_fsm_state.text(x=t_soc_state[10], y=4, text=['NOA_ACTIVE:11'], text_align='left', text_baseline='middle', text_font_size='9pt', text_color='black')
  fig_fsm_state.text(x=t_soc_state[10], y=0, text=['NOA_OVERRIDE:12'], text_align='left', text_baseline='middle', text_font_size='9pt', text_color='black')
