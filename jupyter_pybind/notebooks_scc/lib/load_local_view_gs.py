...
class LoadCyberbag:
  ...
  def load_all_data(self):
    ...
    try:
      json_value_list = ["replan_status", "ego_pos_x", "ego_pos_y", "ego_pos_yaw", 'acc_target_high',
                         "acc_target_low", 'cipv_acc', "VisionLonBehavior_v_limit_road", "VisionLonBehavior_v_limit_in_turns",
