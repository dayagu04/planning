...
def load_car_params_patch(car_type = 'CHERY_E0X'):
  if car_type == 'JAC_S811':
    ...
    # read apa param
    car_x = [3.03816, 3.42037, 3.75,  3.75,  3.42037,  3.03816,  2.12876, 2.01588, 1.91856, 1.97535,
            -0.31524, -0.76338, -1.03, -1.03, -0.76338, -0.31524, 1.97535, 1.91856, 2.01588, 2.12876]
