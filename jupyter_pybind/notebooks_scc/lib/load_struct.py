...
def load_lat_common(plan_debug, planning_json):
  ...
  avoid_debug_key = ["avoid_car_id", "avoid_car_ids_1", "avoid_car_ids_2", \
                        "select_avoid_car_ids_1", "select_avoid_car_ids_2","lat_offset", "smooth_lateral_offset", "lane_width", "smooth_lateral_offset", "normal_avoid_threshold", "avoid_way", "is_use_ego_position","allow_max_opposite_offset", "allow_max_opposite_offset_id",\
