...
#include "motion_planners/scc_lon_motion_planner/src/scc_longitudinal_motion_planning_problem.h"
#include "planning_debug_info.pb.h"

namespace py = pybind11;
using namespace pnc::scc_longitudinal_planning;

static SccLongitudinalMotionPlanningProblem *pBase = nullptr;

int Init() {
  pBase = new SccLongitudinalMotionPlanningProblem();
  pBase->Init();
  return 0;
}
...
PYBIND11_MODULE(scc_lon_motion_planning_py, m) {
  m.doc() = "m";
