...
def load_car_params_patch_parking(vehicle_type = CHERY_E0X, car_lat_inflation = 0.0, fold_mirror_flag=False):
  if vehicle_type == JAC_S811:
    ...
    car_x = [3.45,  3.65,   3.75,   3.75,   3.65,    3.45,   2.05,   2.05,   1.85,  1.85,   -0.48,   -0.88,   -1.03,  -1.03,  -0.88,  -0.48,  1.85,  1.85,  2.05,  2.05]
    car_y = [0.945, 0.6655, 0.245, -0.245, -0.6655, -0.945, -0.945, -1.094, -1.094, -0.945, -0.945,  -0.845,  -0.545,  0.545,  0.845,  0.945, 0.945, 1.094, 1.094, 0.945]
    wheel_base = 2.8
    car_width = 1.89
    if fold_mirror_flag:
      car_x = [3.45,  3.65,   3.75,   3.75,   3.65,    3.45,   2.05,   2.05,   1.85,  1.85,   -0.48,   -0.88,   -1.03,  -1.03,  -0.88,  -0.48,  1.85,  1.85,  2.05,  2.05]
      car_y = [0.945, 0.6655, 0.245, -0.245, -0.6655, -0.945, -0.945, -1.004, -1.004, -0.945, -0.945,  -0.845,  -0.545,  0.545,  0.845,  0.945, 0.945, 1.004, 1.004, 0.945]
