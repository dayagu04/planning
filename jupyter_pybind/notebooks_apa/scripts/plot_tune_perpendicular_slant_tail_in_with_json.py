...
class LocalViewSlider:
  def __init__(self,  slider_callback):
    ...
    self.data_json_id_slider = ipywidgets.IntSlider(layout=ipywidgets.Layout(width='15%'), description= "data_json_id",min=1, max=30, value=1, step=1)
...
### sliders callback
def slider_callback(vehicle_type, car_inflation, selected_id, trigger_plan, data_json_id, ego_offset_lon, ego_offset_lat, ego_offset_heading, is_path_optimization, is_cilqr_enable, is_complete_path):
  kwargs = locals()
  ...
  # 更新仿真参数
  perpendicular_slant_tail_in_with_json_py.UpdateSimuParams(is_path_optimization, is_cilqr_enable, is_complete_path)
  ...
  ego_y = loc_data[1] + ego_offset_lon * math.cos(ego_heading) + ego_offset_lat * math.sin(ego_heading)
