...
from jupyter_pybind import parallel_simulation_hybrid_astar
...
bag_path = '/data_cold/abu_zone/project/chery_dataset/chery_m32t/2026-01-14/05LNNBE21329A9DE177536A41AEF39DE/F39DE-24-adcc120012_20260114140240748/12_120012_24_05LNNBE21329A9DE177536A41AEF39DE_1768370546998_1768370561998_camera_enc.bag'
bag_path = '/data_cold/abu_zone/project/chery_dataset/chery_m32t/2026-01-05/05LNNBE21329A9DE177536A41AEF39DE/F39DE-24-adcc120012_20260105110350118/12_120012_24_05LNNBE21329A9DE177536A41AEF39DE_1767582212822_1767582227822_camera_enc.bag'
...
# try before sliders
parallel_simulation_hybrid_astar.Init()
...
### sliders callback
def slider_callback(bag_time, select_id, pybind_state, sim_to_target, search_sequence_num, force_plan, refresh_thread,is_path_optimization,
                    ...
                    path_plan_method,swap_start_goal,dir):
  ...
  if data_valid['soc_state_msg_idx'] and data_valid['fus_parking_msg_idx'] and data_valid['loc_msg_idx'] and data_valid['vs_msg_idx']:
    ...
    print('plan once')
    res = parallel_simulation_hybrid_astar.PlanOnce(
        soc_state_msg_bytes,
        ...
        sample_ds, pybind_state, target_managed_slot_x_vec,
        target_managed_slot_y_vec,
        target_managed_limiter_x_vec,
        target_managed_limiter_y_vec,
        path_plan_method,
  ...
  if refresh_thread:
    parallel_simulation_hybrid_astar.RefreshThreadResult()
  ...
  if res == True:
    ...
    tuned_planning_output.deserialize(parallel_simulation_hybrid_astar.GetPlanningOutput())
  ...
  path_collision_info = parallel_simulation_hybrid_astar.GetAstarPathCollisionID()
  ...
  # rs
  rs_path = parallel_simulation_hybrid_astar.GetReedsShapePath()
  ...
  if plot_child_node:
    line_list_x_vec, line_list_y_vec = [], []
    node_list = parallel_simulation_hybrid_astar.GetAstarAllNodes()
  ...
  # astar target
  candidates = parallel_simulation_hybrid_astar.GetAstarEndPose()
  candidates_x = []
  candidates_y = []
  ...
  footprint_model = parallel_simulation_hybrid_astar.GetFootPrintModel(current_gear)
  ...
  points = parallel_simulation_hybrid_astar.GetAnchorPoints()
  car_circle_xn = []
  car_circle_yn = []
  car_circle_rn = []
  ...
  cur_gear_path = parallel_simulation_hybrid_astar.GetCurrentGearPath()
  ...
  path_y = []
  path_heading = []
  astar_path = parallel_simulation_hybrid_astar.GetAstarPath()
  ...
  # circle obs
  obs_pts = parallel_simulation_hybrid_astar.GetVirtualWall()
  obs_pt_x, obs_pt_y = [], []
  ...
  # get all rs path
  paths = parallel_simulation_hybrid_astar.GetRSHeuristicPath()
  path_x = []
  path_y = []
  ...
  points = parallel_simulation_hybrid_astar.GetPlotRefLine()
  ...
  path = parallel_simulation_hybrid_astar.GetSearchSequencePath()
  path_x = []
  path_y = []
  ...
  pose = parallel_simulation_hybrid_astar.GetCoordinateSystem()
  ...
  nodes = parallel_simulation_hybrid_astar.GetDelNodeSequencePath()
  node_x = []
  node_y = []
  ...
  nodes = parallel_simulation_hybrid_astar.GetAllSearchNode()
  safe_node_x = []
  safe_node_y = []
  collision_node_x = []
  collision_node_y = []
  ...
  # plot polynomial
  polynomial_path = parallel_simulation_hybrid_astar.GetPolynomialPath()
  plan_path_x = []
  plan_path_y = []
  plan_path_heading = []
  ...
  if (is_reset):
    parallel_simulation_hybrid_astar.StopPybind()

  if plot_speed:
    dp_speed_constraints = parallel_simulation_hybrid_astar.GetDpSpeedConstraints()
    qp_speed_constraints = parallel_simulation_hybrid_astar.GetQPSpeedConstraints()
    ref_cruise_speed = parallel_simulation_hybrid_astar.GetRefCruiseSpeed()
    dp_speed_data = parallel_simulation_hybrid_astar.GetDPSpeedOptimizationData()
    qp_speed_data = parallel_simulation_hybrid_astar.GetQPSpeedOptimizationData()
    ...
    # jlt data
    jlt_speed_data = parallel_simulation_hybrid_astar.GetJLTSpeedData()
    ...
    if res == True:
      planning_proto = planning_debug_info_pb2.PlanningDebugInfo()
      planning_proto.ParseFromString(parallel_simulation_hybrid_astar.GetPlanningDebugInfo())
