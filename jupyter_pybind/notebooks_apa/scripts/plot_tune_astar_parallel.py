...
from jupyter_pybind import astar_parallel_py
...
class LocalViewSlider:
  def __init__(self,  slider_callback):
    ...
    self.right_obj_dx_slider = ipywidgets.FloatSlider(layout=ipywidgets.Layout(width='75%'), description= "right_obj_dx",min=-10.0, max=10.0, value=-0.6, step=0.05)
    ...
    self.right_obj_dy_slider = ipywidgets.FloatSlider(layout=ipywidgets.Layout(width='75%'), description= "right_obj_dy",min=-10, max=20.0, value=7.0, step=0.1)
...
def slider_callback(ego_x, ego_y, ego_heading, slot_pt0_x, slot_pt0_y, is_left, trigger_plan, slot_phi, slot_width, slot_length, right_obj_dx,
  ...
  slot_pt1_x = slot_pt0_x - slot_length
  slot_pt1_y = slot_pt0_y

  slot_pt2_x = slot_pt0_x
  slot_pt2_y = slot_pt0_y - slot_width

  slot_pt3_x = slot_pt0_x - slot_length
  slot_pt3_y = slot_pt0_y - slot_width
  ...
  rs_path = astar_parallel_py.GetReedsShapePath()
  ...
  # plot polynomial
  polynomial_path = astar_parallel_py.GetPolynomialPath()
  ...
  rs_path = astar_parallel_py.GetRSLibPath()
  ...
  path = astar_parallel_py.GetSearchPathPoint()
  plan_path_x = []
  plan_path_y = []
  ...
  nodes = astar_parallel_py.GetAllSearchNode()
  safe_node_x = []
  safe_node_y = []
  collision_node_x = []
  collision_node_y = []
  ...
  # all h rs path
  paths = astar_parallel_py.GetRSHeuristicPath()
  plan_path_x = []
  plan_path_y = []
  ...
  rectangle_solt_pos_vec_ = astar_parallel_py.GetRectangleSoltPos()
  ...
  car_end_pose = astar_parallel_py.GetTargetPose()
  data_car_end_pos.data.update({
    'x': [car_end_pose[0]],
    'y': [car_end_pose[1]],
  })

  pose = astar_parallel_py.GetAstarEndPose()
  ...
  safe_circle_tang_pose = astar_parallel_py.GetCircleTangentPose()
  ...
  # circle obs
  obs_pts = astar_parallel_py.GetVirtualWallObstacles()
  obs_pt_x, obs_pt_y = [], []
  ...
  node_list = astar_parallel_py.GetAstarAllNodes()
  ...
  # obs line
  line_list = astar_parallel_py.GetObsLineList()
  line_list_x_vec, line_list_y_vec = [], []
  ...
  # car_xn = []
  # car_yn = []
  # pose = astar_parallel_py.GetTrajPoseByDist()
  ...
  # vehicle_type = 'CHERY_T26'
  footprint_model = astar_parallel_py.GetFootPrintModel()
