...
fig1.x_range = Range1d(start = -6.0, end = 16.0)
fig1.y_range = Range1d(start = -3.0, end = 12.0)
...
fig1.xaxis.major_label_text_font_size = '18pt'  # 设置字体大小
...
fig1.patches('x_vec', 'y_vec', source = data_car_box, fill_color = "#98FB98", fill_alpha = 0.0, line_color = "black", line_width = 0.3, legend_label = 'Envelope')
...
fig1.patch( 'car_xn', 'car_yn', source = data_start_car, fill_color = "palegreen", fill_alpha = 0.2, line_color = "black", line_width = 1, legend_label = 'Start pose')
...
class LocalViewSlider:
  def __init__(self,  slider_callback):
    self.is_front_occupied_slider = ipywidgets.IntSlider(layout=ipywidgets.Layout(width='15%'), description= "is front occupied",min=0, max=1, value= 0, step=1)
    self.is_rear_occupied_slider = ipywidgets.IntSlider(layout=ipywidgets.Layout(width='15%'), description= "is rear occupied",min=0, max=1, value= 0, step=1)
    ...
    # ego pose
    self.ego_x_slider = ipywidgets.FloatSlider(layout=ipywidgets.Layout(width='75%'), description= "ego_x",min=-15, max=15, value= 1.92, step=0.01)
    self.ego_y_slider = ipywidgets.FloatSlider(layout=ipywidgets.Layout(width='75%'), description= "ego_y",min=-10, max=10, value= 3.48, step=0.01)
    ...
    # obs
    self.lon_space_dx_slider = ipywidgets.FloatSlider(layout=ipywidgets.Layout(width='75%'), description= "lon_space_dx",min=-1.0, max=4.0, value=0.6, step=0.01)
    ...
    self.channel_width_slider = ipywidgets.FloatSlider(layout=ipywidgets.Layout(width='75%'), description= "channel width",min=2.5, max=10.0, value=5.0, step=0.01)

    self.front_car_y_offset_slider = ipywidgets.FloatSlider(layout=ipywidgets.Layout(width='75%'), description= "front obs y",min=-2.0, max=4.0, value=0.4, step=0.01)
    ...
    self.rear_car_heading_slider = ipywidgets.FloatSlider(layout=ipywidgets.Layout(width='75%'), description= "channel width",min=-180.0, max=180.0, value=-2.0, step=0.1)
...
def slider_callback(is_front_occupied, is_rear_occupied, is_all_path, ego_x, ego_y, ego_heading,
  ...
  front_car_heading_rad = front_car_heading * deg2rad
  rear_car_heading_rad = rear_car_heading * deg2rad
  ego_heading_rad = ego_heading * deg2rad
  ...
  construct_scenario(
      ...
      channel_width,
      front_car_y_offset,
      front_car_heading_rad,
      rear_car_y_offset,
      rear_car_heading_rad,
      is_front_occupied,
      is_rear_occupied)
  ...
  parallel_planning_py.UpdateByJson(obs_x_vec, obs_y_vec, slot_width, slot_length, ego_x, ego_y,
                ego_heading_rad, ds)
...
# export_svgs(fig1, filename="00.svg")
