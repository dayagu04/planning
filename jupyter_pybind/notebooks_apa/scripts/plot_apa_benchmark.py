...
log_path = "/asw/planning/glog/open_space_replay.log.INFO.20250924-212503.1566052"
...
planning_total_time = ColumnDataSource(data={'x': [],
                                    'y': [] })
fig1.line('x', 'y', source = planning_total_time, line_width = 2, \
...
def update_time():
  ...
  x = [x for x in range(len(elem_map['planning_total_time']))]
