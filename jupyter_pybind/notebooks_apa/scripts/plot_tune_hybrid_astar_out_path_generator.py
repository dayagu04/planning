...
from jupyter_pybind import hybrid_astar_out_py
...
data_astar_target_line = ColumnDataSource(data = {'x_vec':[], 'y_vec':[]})
...
fig1.multi_line('x_vec', 'y_vec',source = data_astar_target_line, line_width = 3, line_color = 'green', line_dash = 'solid',legend_label = 'data_astar_target_line', visible = False)
...
fig1.line('plan_path_x', 'plan_path_y', source = data_full_astar_path, line_width = 6, line_color = 'green', line_dash = 'solid', line_alpha = 0.5, legend_label = 'sim_tuned_plan', visible = False)
fig1.line('plan_path_x', 'plan_path_y', source = data_planning_tune, line_width = 8, line_color = 'blue', line_dash = 'solid', line_alpha = 0.5, legend_label = 'revised path')
...
hybrid_astar_out_py.Init()

class LocalViewSlider:
  def __init__(self,  slider_callback):
    self.ego_x_slider = ipywidgets.FloatSlider(layout=ipywidgets.Layout(width='75%'), description= "ego_x",min=-10, max=10, value=0.8, step=0.01)
    self.ego_y_slider = ipywidgets.FloatSlider(layout=ipywidgets.Layout(width='75%'), description= "ego_y",min=-10, max=10, value=-5.9, step=0.01)
    ...
    self.virtual_obj_x_slider = ipywidgets.FloatSlider(layout=ipywidgets.Layout(width='75%'), description= "virtual_obj_x",min=-10, max=10, value=-1.5, step=0.01)
    self.virtual_obj_y_slider = ipywidgets.FloatSlider(layout=ipywidgets.Layout(width='75%'), description= "virtual_obj_y",min=-10, max=10, value=-1.5, step=0.01)
    self.virtual_obj_length_slider = ipywidgets.FloatSlider(layout=ipywidgets.Layout(width='75%'), description= "virtual_obj_length",min=-10, max=10, value=1.0, step=0.01)
    self.virtual_obj_width_slider = ipywidgets.FloatSlider(layout=ipywidgets.Layout(width='75%'), description= "virtual_obj_width",min=-10, max=10, value=1.0, step=0.01)
    self.virtual_obj_x_1_slider = ipywidgets.FloatSlider(layout=ipywidgets.Layout(width='75%'), description= "virtual_obj_x_1",min=-10, max=10, value=-1.5, step=0.01)
    self.virtual_obj_y_1_slider = ipywidgets.FloatSlider(layout=ipywidgets.Layout(width='75%'), description= "virtual_obj_y_1",min=-10, max=10, value=5.0, step=0.01)
    self.virtual_obj_length_1_slider = ipywidgets.FloatSlider(layout=ipywidgets.Layout(width='75%'), description= "virtual_obj_length_1",min=-10, max=10, value=1.0, step=0.01)
    self.virtual_obj_width_1_slider = ipywidgets.FloatSlider(layout=ipywidgets.Layout(width='75%'), description= "virtual_obj_width_1",min=-10, max=10, value=1.0, step=0.01)

    self.end_x_slider = ipywidgets.FloatSlider(layout=ipywidgets.Layout(width='75%'), description= "end_x",min=-10, max=10, value=-0.5, step=0.01)
    self.end_y_slider = ipywidgets.FloatSlider(layout=ipywidgets.Layout(width='75%'), description= "end_y",min=-10, max=10, value=6.0, step=0.01)
    self.end_heading_slider = ipywidgets.FloatSlider(layout=ipywidgets.Layout(width='75%'), description= "end_heading",min=0, max=360, value=0.0, step=1)

    self.turn_direction = ipywidgets.IntSlider(layout=ipywidgets.Layout(width='15%'), description= "turn_direction",min=-1, max=1, value=1, step=1)
    ...
    self.left_virtual_wall_x_slider = ipywidgets.FloatSlider(layout=ipywidgets.Layout(width='75%'), description= "left_virtual_wall_x",min=-30.0, max=20.0, value=-20, step=0.05)
    self.right_virtual_wall_x_slider = ipywidgets.FloatSlider(layout=ipywidgets.Layout(width='75%'), description= "right_virtual_wall_x",min=0.0, max=20.0, value=20, step=0.05)
    ...
    self.left_obj_dx_slider = ipywidgets.FloatSlider(layout=ipywidgets.Layout(width='75%'), description= "left_obj_dx",min=-2.0, max=2.0, value=0.2, step=0.05)
    ...
    self.channel_width_slider = ipywidgets.FloatSlider(layout=ipywidgets.Layout(width='75%'), description= "channel_width",min=3.0, max=20, value=6.0, step=0.1)
    ...
    ipywidgets.interact(slider_callback, ego_x=self.ego_x_slider,
                        ...
                        virtual_obj_x=self.virtual_obj_x_slider,
                        virtual_obj_y=self.virtual_obj_y_slider,
                        virtual_obj_length=self.virtual_obj_length_slider,
                        virtual_obj_width=self.virtual_obj_width_slider,
                        virtual_obj_x_1=self.virtual_obj_x_1_slider,
                        virtual_obj_y_1=self.virtual_obj_y_1_slider,
                        virtual_obj_length_1=self.virtual_obj_length_1_slider,
                        virtual_obj_width_1=self.virtual_obj_width_1_slider,
...
## sliders callback
def slider_callback(ego_x, ego_y, ego_heading, end_x, end_y, end_heading, virtual_obj_x, virtual_obj_y, virtual_obj_length, virtual_obj_width,
                    virtual_obj_x_1, virtual_obj_y_1, virtual_obj_length_1, virtual_obj_width_1,
                    slot_pt0_x, slot_pt0_y, turn_direction, trigger_plan,
                    slot_phi, slot_width, slot_length, inside_dx, right_obj_dx, right_obj_dy, left_obj_dx, left_obj_dy, channel_width,
                    right_virtual_wall_x, left_virtual_wall_x):
  kwargs = locals()
  ...
  obs_params = [right_obj_dx, right_obj_dy, left_obj_dx, left_obj_dy,
                ...
                virtual_obj_x, virtual_obj_y, virtual_obj_length, virtual_obj_width,
                virtual_obj_x_1, virtual_obj_y_1, virtual_obj_length_1, virtual_obj_width_1]

  end_pos_offset_vec = [end_x, end_y, end_heading]
  current_path_point_global_vec_ = hybrid_astar_out_py.Update(
      ego_pose, slot_pt, inside_dx, obs_params, trigger_plan, turn_direction, end_pos_offset_vec)
  ...
  rs_path = hybrid_astar_out_py.GetReedsShapePath()
  ...
  # plot polynomial
  polynomial_path = hybrid_astar_out_py.GetPolynomialPath()
  ...
  rs_path = hybrid_astar_out_py.GetRSLibPath()
  ...
  path = hybrid_astar_out_py.GetSearchPathPoint()
  plan_path_x = []
  plan_path_y = []
  ...
  nodes = hybrid_astar_out_py.GetAllSearchNode()
  safe_node_x = []
  safe_node_y = []
  collision_node_x = []
  collision_node_y = []
  ...
  # all h rs path
  paths = hybrid_astar_out_py.GetRSHeuristicPath()
  plan_path_x = []
  plan_path_y = []
  ...
  rectangle_solt_pos_vec_ = hybrid_astar_out_py.GetRectangleSoltPos()
  ...
  car_end_pose = hybrid_astar_out_py.GetTargetPose()
  data_car_end_pos.data.update({
    'x': [car_end_pose[0]],
    'y': [car_end_pose[1]],
  })

  pose = hybrid_astar_out_py.GetAstarEndPose()
  data_astar_target_pos.data.update({
    'x': [pose[0]],
    'y': [pose[1]],
  })

  extend_pose = hybrid_astar_out_py.GetAstarTargetLine()
  target_line_x_vec = []
  target_line_y_vec = []
  target_line_x_vec.append([pose[0], extend_pose[0]])
  target_line_y_vec.append([pose[1], extend_pose[1]])

  data_astar_target_line.data.update({
    'x_vec': target_line_x_vec,
    'y_vec': target_line_y_vec,
  })
  ...
  revised_path_point_global_vec_ = hybrid_astar_out_py.GetRevisedPath()

  for i in range(len(revised_path_point_global_vec_)):
     plan_path_x.append(revised_path_point_global_vec_[i][0])
     plan_path_y.append(revised_path_point_global_vec_[i][1])
     plan_path_heading.append(revised_path_point_global_vec_[i][2])
  ...
  pt_inside_pos = hybrid_astar_out_py.GetPtInsidePose()
  ...
  safe_circle_tang_pose = hybrid_astar_out_py.GetCircleTangentPose()
  ...
  # circle obs
  obs_pts = hybrid_astar_out_py.GetVirtualWallObstacles()
  obs_pt_x, obs_pt_y = [], []
  ...
  node_list = hybrid_astar_out_py.GetAstarAllNodes()
  ...
  # obs line
  line_list = hybrid_astar_out_py.GetObsLineList()
  line_list_x_vec, line_list_y_vec = [], []
  ...
  # car_xn = []
  # car_yn = []
  # pose = hybrid_astar_out_py.GetTrajPoseByDist()
  ...
  # vehicle_type = 'CHERY_T26'
  footprint_model_global = hybrid_astar_out_py.GetFootPrintModelGlobal()
  ...
  pose = hybrid_astar_out_py.GetCurrentGearPathEnd()
  footprint_model_local = hybrid_astar_out_py.GetFootPrintModelLocal()
