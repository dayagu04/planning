...
bag_path = "/data_cold/abu_zone/autoparse/jac_s811_35kw2/trigger/20240220/20240220-15-50-18/data_collection_JAC_S811_35KW2_EVENT_MANUAL_2024-02-20-15-50-18.record"
frame_dt = 0.1 # sec
...
class LocalViewSlider:
  def __init__(self,  slider_callback):
    ...
    self.q_continuity = ipywidgets.FloatSlider(layout=ipywidgets.Layout(width='50%'), description= "q_continuity",min=0.01, max=1.0, value=lat_motion_plan_input0.q_continuity, step=0.01)
    ...
    ipywidgets.interact(slider_callback, bag_time = self.time_slider,
                                         ...
                                         q_continuity = self.q_continuity
                                         )


### sliders callback
def slider_callback(bag_time, q_ref_xy, q_ref_theta, q_acc, q_jerk, q_acc_bound, q_jerk_bound, acc_bound, jerk_bound, q_safe_bound,q_hard_bound, upper_safe_bound, lower_safe_bound, q_continuity):
  kwargs = locals()
  ...
  lateral_motion_planning_py.UpdateByParams(input_string, q_ref_xy, q_ref_theta, q_acc, q_jerk, q_acc_bound, q_jerk_bound, acc_bound, jerk_bound, q_safe_bound, q_hard_bound, upper_safe_bound, lower_safe_bound, q_continuity)
