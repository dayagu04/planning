...
fig1.circle('x','y', source = data_obs_pos, size=8, color='orange', alpha = 0.4, legend_label = 'obs_pos', visible = True)
...
class LocalViewSlider:
  def __init__(self,  slider_callback):
    ...
    self.ego_x_slider = ipywidgets.FloatSlider(layout=ipywidgets.Layout(width='75%'), description= "ego_x",min=-10, max=10, value=0.80, step=0.01)
    self.ego_y_slider = ipywidgets.FloatSlider(layout=ipywidgets.Layout(width='75%'), description= "ego_y",min=-10, max=10, value=-5.80, step=0.01)
    self.ego_heading_slider = ipywidgets.FloatSlider(layout=ipywidgets.Layout(width='75%'), description= "ego_heading",min=0, max=360, value=90.0, step=0.2)
...
### sliders callback
def slider_callback(vehicle_type, car_inflation, direction, ego_x, ego_y, ego_heading, is_left, is_astar, slot_phi,
  ...
  perpendicular_parking_out_py.UpdateLocalization([ego_x, ego_y, ego_heading/57.3])
  ...
  perpendicular_parking_out_py.UpdateSlot([pt_0, pt_1, pt_2, pt_3])

  perpendicular_parking_out_py.UpdateStateMachine()
  perpendicular_parking_out_py.UpdateApaParkOutDirection(direction)

  perpendicular_parking_out_py.Update()

  complete_path_pt_vec = perpendicular_parking_out_py.GetCompletePlanPath()
  cur_gear_path_pt_vec = perpendicular_parking_out_py.GetCurrentGearPlanPath()
  ...
  obs_vec = perpendicular_parking_out_py.GetObsVec()
  obs_pt_x, obs_pt_y = [], []
