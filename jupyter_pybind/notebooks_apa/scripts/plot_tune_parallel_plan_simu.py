...
## t-lane
fig1.line('x_vec', 'y_vec',source = data_slot, line_width = 2.5, line_color = 'black', line_dash = 'solid',legend_label = 'slot')
...
# obstacles
fig1.scatter("x_vec", "y_vec", source=data_obs_pt, size=8, color='blue',legend_label = 'obstacle pts')
