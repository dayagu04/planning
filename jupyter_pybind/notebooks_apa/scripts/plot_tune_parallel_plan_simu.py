...
class LocalViewSlider:
  def __init__(self,  slider_callback):
    ...
    # obs pt pos
    self.obs_tlane_p_inside_x_slider = ipywidgets.FloatSlider(layout=ipywidgets.Layout(width='75%'), description= "obs_in_x",min=-15, max=15, value= 6.45913, step=0.01)
    ...
    self.obs_tlane_p_outside_x_slider = ipywidgets.FloatSlider(layout=ipywidgets.Layout(width='75%'), description= "obs_out_x",min=-15, max=15, value= -0.433143, step=0.01)
    ...
    # terminal pos
    self.tlane_pt_x_slider = ipywidgets.FloatSlider(layout=ipywidgets.Layout(width='75%'), description= "tlane_pt_x",min=-2.0, max=2.0, value= 1.63856, step=0.01)
