...
def update_local_view_data_parking(fig1, bag_loader, bag_time, local_view_data):
  ...
  if bag_loader.soc_state_msg['enable'] == True:
    ...
    print(str(bag_loader.soc_state_msg['data'][soc_state_msg_idx].current_state))
  ...
  if bag_loader.ctrl_msg['enable'] == True:
    ...
    # print(local_view_data['data_control'].data)
    # print(local_view_data['data_control'].data['mpc_dx'])
...
def load_local_view_figure_parking(bag_loader):
  ...
  return fig1, local_view_data, fig2, fig3, fig4, fig5, fig6, fig7, data_ctrl_debug_table
