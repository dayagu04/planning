...
bag_path = '/home/gdbai2/test_data/0913/apa_14.00000'
frame_dt = 0.1 # sec
parking_flag = True
...
class LocalViewSlider:
  def __init__(self,  slider_callback):
    ...
    self.max_slots_update_angle_dis_limit_deg_slider = ipywidgets.FloatSlider(layout=ipywidgets.Layout(width='30%'), description= "max_slots_update_angle_dis_limit_deg",min=0, max=25, value=20, step=0.5)
    self.max_slot_boundary_line_angle_dif_deg_slider = ipywidgets.IntSlider(layout=ipywidgets.Layout(width='30%'), description= "slot_angle_dif_deg",min=0, max=60, value=20, step=1)
    ...
    self.min_slot_update_lon_dif_slot_center_to_mirror_slider = ipywidgets.FloatSlider(layout=ipywidgets.Layout(width='30%'), description= "min lon dif",min=0, max=1.0, value=0.35, step=0.05)
