...
# init pybind
realtime_lateral_motion_planning_py.Init()
...
class LocalViewSlider:
  def __init__(self,  slider_callback):
    ...
    self.theta1_bound_slider = ipywidgets.FloatSlider(layout=ipywidgets.Layout(width='30%'), description= "theta1",min=0.0, max=0.5, value=0.2, step=0.02)
    self.theta2_bound_slider = ipywidgets.FloatSlider(layout=ipywidgets.Layout(width='30%'), description= "theta2",min=0.0, max=2.0, value=0.5, step=0.02)
    ...
    ipywidgets.interact(slider_callback, bag_time = self.time_slider,
                                         ...
                                         theta1 = self.theta1_bound_slider,
                                         theta2 = self.theta2_bound_slider,
...
### sliders callback
def slider_callback(bag_time, q_ref_xy, q_ref_theta, q_acc, q_jerk, q_acc_bound, q_jerk_bound, acc_bound, jerk_bound, theta1, theta2):
  kwargs = locals()
  update_local_view_data(fig1, bag_loader, bag_time, local_view_data)
  update_tune_lat_plan_data(bag_loader, bag_time, local_view_data, lat_plan_data,0.0, 0.0)
  ...
  realtime_lateral_motion_planning_py.UpdateByParams(input_string, q_ref_xy, q_ref_theta, q_acc, q_jerk, q_acc_bound, q_jerk_bound, acc_bound, jerk_bound, 0.0, 0.0, 0.0, 0.0)

  planning_output = lateral_motion_planner_pb2.LateralPlanningOutput()
  output_string_tmp = realtime_lateral_motion_planning_py.GetOutputBytes()
  ...
  ref_x_vec = lat_motion_plan_input.ref_x_vec
  ref_y_vec = lat_motion_plan_input.ref_y_vec
