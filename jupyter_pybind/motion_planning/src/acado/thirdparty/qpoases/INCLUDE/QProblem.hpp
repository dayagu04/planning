...
public:
   ...
   *	using an initial homotopy with empty working set (at most nWSR
   iterations). *	\return SUCCESSFUL_RETURN \n RET_INIT_FAILED \n
                          ...
                          RET_NO_SOLUTION */
  returnValue
  init(const real_t *const _H,   /**< Hessian matrix. */
       const real_t *const _g,   /**< Gradient vector. */
       const real_t *const _A,   /**< Constraint matrix. */
       const real_t *const _lb,  /**< Lower bound vector (on
                                    variables). \n  If no lower bounds
                                    exist, a NULL pointer can be
                                    passed. */
       const real_t *const _ub,  /**< Upper bound vector (on
                                    variables). \n  If no upper bounds
                                    exist, a NULL pointer can be
                                    passed. */
       const real_t *const _lbA, /**< Lower constraints' bound
                                    vector. \n If no lower
                                    constraints' bounds exist, a
                                    NULL pointer can be passed. */
       const real_t *const _ubA, /**< Upper constraints' bound
                                    vector. \n If no lower
                                    constraints' bounds exist, a
                                    NULL pointer can be passed. */
       int &nWSR,                /**< Input: Maximum number of working set
                                    recalculations when using initial homotopy.
                                                 Output: Number of performed
                                    working set recalculations. */
       const real_t *const yOpt =
           0, /**< Initial guess for dual solution vector. */
       real_t *const cputime =
           0 /**< Output: CPU time required to initialise QP. */
  );
  ...
  init(const real_t *const _H, /**< Hessian matrix. */
       const real_t
           *const _R, /**< Cholesky factorization of the Hessian matrix. */
       const real_t *const _g,   /**< Gradient vector. */
       const real_t *const _A,   /**< Constraint matrix. */
       const real_t *const _lb,  /**< Lower bound vector (on
                                    variables). \n  If no lower bounds
  ...
  returnValue hotstart(
      const real_t
          *const g_new, /**< Gradient of neighbouring QP to be solved. */
      const real_t
          *const lb_new, /**< Lower bounds of neighbouring QP to be
                            solved. \n  If no lower bounds exist, a NULL
                            pointer can be passed. */
      const real_t
          *const ub_new,           /**< Upper bounds of neighbouring QP to be
                                      solved. \n  If no upper bounds exist, a NULL
                                      pointer can be passed. */
      const real_t *const lbA_new, /**< Lower constraints' bounds of
                                      neighbouring QP to be solved. \n If no
                                      lower constraints' bounds exist, a NULL
                                      pointer can be passed. */
      const real_t *const ubA_new, /**< Upper constraints' bounds of
                                      neighbouring QP to be solved. \n If no
                                      upper constraints' bounds exist, a NULL
                                      pointer can be passed. */
      int &nWSR, /**< Input: Maximum number of working set recalculations; \n
                                  Output: Number of performed working set
                    recalculations. */
      real_t *const cputime /**< Output: CPU time required to solve QP (or to
                               perform nWSR iterations). */
  );

  /** Returns constraint matrix of the QP (deep copy).
   *	\return SUCCESSFUL_RETURN */
  inline returnValue getA(real_t *const _A /**< Array of appropriate dimension
                                              for copying constraint matrix.*/
                          ) const;
  ...
  inline returnValue
  getA(int number,       /**< Number of entry to be returned. */
       real_t *const row /**< Array of appropriate dimension for copying
                            (number)th constraint. */
       ) const;

  /** Returns lower constraints' bound vector of the QP (deep copy).
   *	\return SUCCESSFUL_RETURN */
  inline returnValue getLBA(real_t *const _lbA /**< Array of appropriate
                                                  dimension for copying lower
                                                  constraints' bound vector.*/
                            ) const;
   ...
   *	\return SUCCESSFUL_RETURN */
  inline returnValue getUBA(real_t *const _ubA /**< Array of appropriate
                                                  dimension for copying upper
                                                  constraints' bound vector.*/
                            ) const;
   ...
   *	\return SUCCESSFUL_RETURN */
  inline returnValue getConstraints(
      Constraints *const _constraints /** Output: Constraints object. */
      ) const;
...
protected:
  ...
  returnValue solveInitialQP(
      ...
      const real_t *const yOpt,          /**< Optimal dual solution vector.
                                          *	 A NULL pointer can be passed. */
      const Bounds *const guessedBounds, /**< Guessed working set of
                                          *bounds for solution
                                          *(xOpt,yOpt). A NULL
                                          *pointer can be passed.
                                          */
      const Constraints *const guessedConstraints, /**< Optimal
                                                    *working set of
                                                    *constraints for
                                                    *solution
                                                    *(xOpt,yOpt). A
      ...
      int &nWSR,            /**< Input: Maximum number of working set
                             *recalculations; \n            Output: Number of performed
                             *working set recalculations. */
      real_t *const cputime /**< Output: CPU time required to solve
                               QP (or to perform nWSR iterations). */
  );
  ...
  returnValue obtainAuxiliaryWorkingSet(
      ...
      const real_t *const yOpt, /**< Optimal dual solution vector.
                                 ...
                                 *entries are assumed to be zero. */
      const Bounds
          *const guessedBounds, /**< Guessed working set of bounds for solution
                                   (xOpt,yOpt). */
      const Constraints
          *const guessedConstraints, /**< Guessed working set for solution
                                        (xOpt,yOpt). */
  ...
  returnValue setupAuxiliaryWorkingSet(
      ...
      const Constraints *const auxiliaryConstraints, /**< Working set of
                                                        constraints for
                                                        auxiliary QP. */
      BooleanType
  ...
  returnValue setupAuxiliaryQPbounds(
      ...
      const Constraints *const auxiliaryConstraints, /**< Working set of
                                                        ...
                                                        auxiliary QP. */
      BooleanType
          useRelaxation /**< Flag indicating if inactive (constraints') bounds
                           shall be relaxed. */
  );
   ...
   *	\return SUCCESSFUL_RETURN \n
                          ...
                          RET_ENSURELI_FAILED */
  returnValue
  addBound(int number, /**< Number of bound to be added to active set. */
   ...
   *	\return	 RET_LINEARLY_DEPENDENT \n
                           RET_LINEARLY_INDEPENDENT */
  returnValue
  addBound_checkLI(int number /**< Number of bound to be added to active set. */
  );
   ...
   *	\return SUCCESSFUL_RETURN \n
                          ...
                          RET_HESSIAN_NOT_SPD */
  returnValue
  removeConstraint(int number,                /**< Number of constraint to be
                                                 removed from active set. */
                   BooleanType updateCholesky /**< Flag indicating if
  ...
  returnValue
  removeBound(int number, /**< Number of bound to be removed from active set. */
              BooleanType updateCholesky /**< Flag indicating if Cholesky
                                            decomposition shall be updated. */
  );
  ...
  returnValue backsolveR(const real_t *const b,  /**< Right hand side vector. */
                         BooleanType transposed, /**< Indicates if the
                                                    transposed system shall be
                                                    solved. */
  ...
  returnValue backsolveR(const real_t *const b,  /**< Right hand side vector. */
                         BooleanType transposed, /**< Indicates if the
                                                    transposed system shall be
                                                    solved. */
                         BooleanType removingBound, /**< Indicates if function
                                                       is called from
                                                       "removeBound()". */
                         real_t *const a /**< Output: Solution vector */
  );
  ...
  returnValue hotstart_determineStepDirection(
      ...
      const real_t
          *const delta_lbA, /**< Step direction of lower constraints' bounds. */
      const real_t
          *const delta_ubA, /**< Step direction of upper constraints' bounds. */
      const real_t *const delta_lb, /**< Step direction of lower bounds. */
      const real_t *const delta_ub, /**< Step direction of upper bounds. */
      BooleanType
          Delta_bC_isZero, /**< Indicates if active constraints' bounds are to
                              be shifted. */
      BooleanType
   ...
   *	\return SUCCESSFUL_RETURN \n
                          RET_INVALID_ARGUMENTS */
  returnValue
  setupQPdata(const real_t *const _H, /**< Hessian matrix. */
              const real_t *const
              ...
              const real_t *const _lbA, /**< Lower constraints' bound vector. \n
                                                                         If no
                                           lower constraints' bounds exist, a
                                           NULL pointer can be passed. */
   ...
   *	\return  SUCCESSFUL_RETURN \n */
  returnValue
  printIteration(int iteration,            /**< Number of current iteration. */
  ...
  inline returnValue
  setA(const real_t
           *const A_new /**< New constraint matrix (with correct dimension!). */
  );

  /** Changes single row of constraint matrix of the QP. \n
          (Remark: Also correponding component of internal vector Ax is
   recomputed!) *	\return SUCCESSFUL_RETURN  \n RET_INDEX_OUT_OF_BOUNDS */
  inline returnValue
  setA(int number, /**< Number of row to be changed. */
       const real_t *const
   ...
   *	\return SUCCESSFUL_RETURN */
  inline returnValue setLBA(const real_t *const lbA_new /**< New constraints'
                                                           lower bound vector
                                                           (with correct
                                                           dimension!). */
  );
  ...
  inline returnValue setLBA(int number,  /**< Number of entry to be changed. */
                            real_t value /**< New value for entry of lower
                                            constraints' bound vector (with
                                            correct dimension!). */
  );

  /** Sets constraints' upper bound vector of the QP.
   *	\return SUCCESSFUL_RETURN */
  inline returnValue setUBA(const real_t *const ubA_new /**< New constraints'
                                                           upper bound vector
                                                           (with correct
                                                           dimension!). */
  );
  ...
  inline returnValue setUBA(int number,  /**< Number of entry to be changed. */
                            real_t value /**< New value for entry of upper
                                            constraints' bound vector (with
                                            correct dimension!). */
  );
...
protected:
  ...
  real_t Ax[NCMAX_ALLOC]; /**< Stores the current product A*x (for increased
                             efficiency only). */

  CyclingManager
      cyclingManager; /**< Data structure for storing (possible) cycling
