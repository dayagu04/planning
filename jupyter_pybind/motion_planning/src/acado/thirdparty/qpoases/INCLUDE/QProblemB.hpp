...
public:
   ...
   *	\return SUCCESSFUL_RETURN */
  inline returnValue
  getLB(real_t *const _lb /**< Array of appropriate dimension for copying lower
                             bound vector.*/
        ) const;
   ...
   *	\return SUCCESSFUL_RETURN */
  inline returnValue
  getUB(real_t *const _ub /**< Array of appropriate dimension for copying upper
                             bound vector.*/
        ) const;
   ...
   *	\return SUCCESSFUL_RETURN */
  inline returnValue
  getBounds(Bounds *const _bounds /** Output: Bounds object. */
            ) const;
...
protected:
  ...
  returnValue solveInitialQP(
      ...
      const real_t *const yOpt,          /**< Optimal dual solution vector.
                                          *	 A NULL pointer can be passed. */
      const Bounds *const guessedBounds, /**< Guessed working set for
                                          *solution (xOpt,yOpt). A
                                          *NULL pointer can be
                                          *passed. */
      int &nWSR,            /**< Input: Maximum number of working set
                             *recalculations; \n            Output: Number of performed
   ...
   *	\return SUCCESSFUL_RETURN \n
                          RET_UNKNOWN BUG */
  returnValue
  setupAuxiliaryQPbounds(BooleanType useRelaxation /**< Flag indicating if
                                                      inactive bounds shall be
                                                      relaxed. */
  );
 ...
 */
  ...
  inline returnValue
  setH(const real_t
           *const H_new /**< New Hessian matrix (with correct dimension!). */
  );
  ...
  inline returnValue
  setG(const real_t
           *const g_new /**< New gradient vector (with correct dimension!). */
  );
   ...
   *	\return SUCCESSFUL_RETURN  \n
                          RET_INDEX_OUT_OF_BOUNDS */
  inline returnValue
  setLB(int number,  /**< Number of entry to be changed. */
   ...
   *	\return SUCCESSFUL_RETURN  \n
                          RET_INDEX_OUT_OF_BOUNDS */
  inline returnValue
  setUB(int number,  /**< Number of entry to be changed. */
...
protected:
  ...
  BooleanType hasHessian;  /**< Flag indicating whether H contains Hessian or
                              corresponding Cholesky factor R; \sa init. */
  ...
  BooleanType hasCholesky; /**< Flag indicating whether Cholesky decomposition
  ...
  int count; /**< Counts the number of hotstart function calls (internal usage
                only!). */
};
