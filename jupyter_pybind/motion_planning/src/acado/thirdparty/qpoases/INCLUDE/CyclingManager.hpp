...
/** This class is intended to detect and handle possible cycling during QP
 *iterations. As cycling seems to occur quite rarely, this class is NOT FULLY
 *IMPLEMENTED YET!
 *
 *	\author Hans Joachim Ferreau
 *	\version 1.3embedded
...
public:
  ...
  returnValue setCyclingStatus(
      ...
      BooleanType
          isBound, /**< Flag that indicates if given number corresponds to a
  ...
  CyclingStatus getCyclingStatus(
      int number, /**< Number of bound/constraint. */
      BooleanType
          isBound /**< Flag that indicates if given number corresponds to
...
protected:
  ...
  CyclingStatus status[NVMAX + NCMAX]; /**< Array to store cycling status of all
                                          bounds/constraints. */
