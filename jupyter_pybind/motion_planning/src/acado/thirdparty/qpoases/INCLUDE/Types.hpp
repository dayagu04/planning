...
enum QProblemStatus {
  ...
  QPS_PREPARINGAUXILIARYQP, /**< An auxiliary problem is currently setup, either
                             * at the very beginning via an initial homotopy or
                             * after changing the QP matrices. */
  QPS_AUXILIARYQPSOLVED, /**< An auxilary problem was solved, either at the very
                          * beginning via an initial homotopy or after changing
                          * the QP matrices. */
...
enum CyclingStatus {
  ...
  CYC_PREV_ADDED,   /**< Bound/constraint has previously been added during the
                       current cycling. */
  CYC_PREV_REMOVED  /**< Bound/constraint has previously been removed during the
                       current cycling. */
};
