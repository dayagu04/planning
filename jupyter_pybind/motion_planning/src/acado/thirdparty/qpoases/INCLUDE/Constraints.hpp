...
public:
  ...
  returnValue
  setupConstraint(int _number,            /**< Number of new constraint. */
   ...
   *	\return SUCCESSFUL_RETURN */
  inline returnValue
  setNEC(int n /**< Number of implicit equality constraints. */
  );

  /** Sets number of "real" inequality constraints.
   *	\return SUCCESSFUL_RETURN */
  inline returnValue
  setNIC(int n /**< Number of "real" inequality constraints. */
  );
