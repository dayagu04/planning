...
bag_path = "/docker_share/code/new_planning_3/planning/20230206171613.record.00000"
frame_dt = 0.02
...
fig1.line('line_0_y', 'line_0_x', source = data_lane, line_width = 1, line_color = 'black', line_dash = 'dashed', legend_label = 'lane')
fig1.line('line_1_y', 'line_1_x', source = data_lane, line_width = 1, line_color = 'black', line_dash = 'dashed', legend_label = 'lane')
fig1.line('line_2_y', 'line_2_x', source = data_lane, line_width = 1, line_color = 'black', line_dash = 'dashed', legend_label = 'lane')
fig1.line('line_3_y', 'line_3_x', source = data_lane, line_width = 1, line_color = 'black', line_dash = 'dashed', legend_label = 'lane')
fig1.line('line_4_y', 'line_4_x', source = data_lane, line_width = 1, line_color = 'black', line_dash = 'dashed', legend_label = 'lane')
fig1.line('line_5_y', 'line_5_x', source = data_lane, line_width = 1, line_color = 'black', line_dash = 'dashed', legend_label = 'lane')
