...
class CurveLayer:
  ...
  def __init__(self, fig, params):
    ...
    # hover = HoverTool(renderers=[self.plot], tooltips=[(self.xs, '@pts_xs'), (self.ys, '@pts_ys')], mode='vline')
  ...
  # def addhover(self, x, y, z):
  #   hover = HoverTool(renderers=[self.plot], tooltips=[(x, '@pts_xs'), (y, '@pts_ys')], mode='vline')
  #   self.fig.add_tools(hover)
