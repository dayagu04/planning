 ...
 * 
 *  Matrix containing 25 reference/measurement vectors of size 3 for first 25 nodes.
 */
real_t y[ 75 ];
...
/** Matrix of size: 29 x 29 (row major format) */
real_t H[ 841 ];

/** Matrix of size: 125 x 29 (row major format) */
real_t A[ 3625 ];
